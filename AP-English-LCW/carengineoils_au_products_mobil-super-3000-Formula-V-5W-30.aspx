...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super 3000 Formula V 5W-30 - Australia | Mobil&trade; Asia Pacific</title>
        <meta name="keywords" content="Mobil Super 3000 Formula V 5W-30"/>
        <meta name="description" content="Mobil Super 3000 Formula V 5W-30 is a low ash high performance motor oil designed to meet the demanding requirements of extended service life whilst still contributing towards fuel economy and superior engine cleanliness."/>
        <meta name="date" content="2015-07-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super 3000 Formula V 5W-30 - Australia | Mobil&trade; Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8193be16");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8193be16','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8193be16', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8193be16', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../ap-english-lcw/images/product_120x150_Mobil-Super-mobil-super-3000-Formula-V-5W-30.jpg" alt=" Mobil Super 3000 Formula V 5W-30 " title=" Mobil Super 3000 Formula V 5W-30 " align="left"> </div>
                        <h1>Mobil &trade; Super 3000 Formula V 5W-30</h1>
                        <p xmlns="">Mobil Super 3000 Formula V 5W-30 is a low ash high performance motor oil designed to meet the demanding requirements of extended service life whilst still contributing towards fuel economy and superior engine cleanliness.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8193be16', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <ul xmlns="">
                                        ...
                                        <li>Extended service interval as per VW requirements.</li>
    
                                        <li>Helping achieve fuel economy (as per ACEA C3).</li>
    
                                        <li>Improved engine internal cleanliness to maintain engine efficiency over life of vehicle.</li>
    
                                        <li>Fast circulation and protection.</li>
    
                                        <li>Full compatibility with most diesel particulate filters and catalytic convertors.</li>

                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil Super 3000 Formula V 5W-30 has been designed to meet the needs of the latest engine requirements of the VW Audi group where extended drain is required in conjunction with electronic service indicators with VW extended drain service schedule.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <b>Mobil Super 3000 Formula V 5W-30 has the following builder approvals: </b>
                                        <br>
Volkswagen VW 504 00 / 507 00 <br>
Porsche C30</p>

                                    <p xmlns="">
                                        <b>Mobil Super 3000 Formula V 5W-30 meets or exceeds the requirements of: </b>
                                        <br>
ACEA C3</p>
                                </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="291" scope="col" height="25" class="standard">
                                                    ...
                                                    <p>Mobil Super 3000 Formula V 5W-30</p>
