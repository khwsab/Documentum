...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super&trade; 1000 20W-50 - Australia | Mobil&trade; Asia Pacific</title>
        <meta name="keywords" content="Mobil Super 1000 20W-50"/>
        <meta name="description" content="Mobil Super&trade; 1000 20W-50 - Premium Multigrade Passenger Vehicle Engine Oils"/>
        <meta name="date" content="2012-08-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super&trade; 1000 20W-50 - Australia | Mobil&trade; Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81326802");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81326802','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81326802', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        ...
                        <h2>
                            <a title="" target="_self" href="/AP-English-LCW/wheretobuy_find-a-mobil-distributor.aspx">
Find an ExxonMobil distributor</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">Buy Mobil Super&trade; 1000 20W-50 through an <br>
...
car care tips</a>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81326802', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../AP-English-LCW/Images/product_120x150_mobil-super-1000-20w50_au.jpg" height="150" width="120" alt="Mobil Super 1000 20W-50" title="Mobil Super 1000 20W-50" align="left" border="0" hspace="0"> </div>
                        <h1>Mobil Super&trade; 1000 20W-50</h1>
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81326802', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                            ...
                                            <thead>
                                                <tr>
                                                    <th width="70%" scope="col" height="" class="standard">
                                                        <p>
                                                            <strong>Mobil Super 1000 </strong><strong>20W-50 </strong><strong>meets or exceeds the requirements of:</strong>
                                                        </p>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th width="" scope="col" height="" class="standard">
                                                        <p>
                                                            <strong>Mobil Super 1000 </strong><strong>20W-50 </strong><strong>is recommended by ExxonMobil for use in applications requiring:</strong>
                                                        </p>
                                                    </th><th width="" scope="col" height="" class="standard">&nbsp;</th>
                                                </tr>
                                            </thead><tbody><tr>
                                                <td width="" height="" class="standard">API</td><td width="" height="" class="standard">CF</td>
                                            </tr></tbody></table>
                                    </p>
                                </div>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th width="81%" scope="col" height="" class="standard">
                                                        <p>
                                                            <strong>Mobil Super 1000 </strong><strong>&nbsp;20W-50</strong>
                                                        </p>
