...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8120a933");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8120a933','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d8120a933", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d8120a933", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d8120a933", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                            <div id="flashVideoTop"/>
                        </div>
                        <p/>
                        <h1>Downloads</h1>
                        <p xmlns="">Download the latest Mobil&trade; wallpapers.</p>
                        <p xmlns="">
                            <img src="../AP-English-LCW/Images/article_154x96_winter.jpg" height="116" width="154" alt="download" title="download" border="0" hspace="0"></p>
                        <p xmlns="">
                            <a title="" target="_blank" onclick="trackClick(this);" href="/AP-English-LCW/Images/article_800x600_winter.jpg" class="">800 x 600</a>
                            <br>
                            <a title="" target="_blank" onclick="trackClick(this);" href="/AP-English-LCW/Images/article_1024x768_winter.jpg" class="">1024 x 768</a>
                            <br>
                            <a title="" target="_blank" onclick="trackClick(this);" href="/AP-English-LCW/Images/article_1280x1024_winter.jpg" class="">1280 x 1024</a>
                        </p>
                    </div>
                </div>
