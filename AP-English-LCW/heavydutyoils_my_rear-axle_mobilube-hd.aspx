...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobilube&trade; HD 80W-90, 85W-140 - Malaysia | Mobil&trade; Asia Pacific</title>
        <meta name="keywords" content="Mobilube HD 80W-90, 85W-140"/>
        <meta name="description" content="Mobilube&trade; HD 80W-90, 85W-140 - Heavy Duty Automotive Gear Lubricants"/>
        <meta name="date" content="2012-08-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobilube&trade; HD 80W-90, 85W-140 - Malaysia | Mobil&trade; Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81326a3a");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81326a3a','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81326a3a', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left"><a xmlns="" target="_self" onclick="trackClick(this);" href="../AP-English-LCW/heavydutyoils_my_transmission-products.aspx"><img width="60" title="greases" src="../Shared-Images-LCW/teaser_60x60_transmission_gbl.jpg" longdesc="" height="60" border="0" alt="greases"></a> </div>
                        <h2>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81326a3a', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash"> </div>
                        <p xmlns="">
                            <em><img src="../AP-English-LCW/Images/product_120x150_mobilube-hd_my.jpg" height="150" width="120" alt="Mobilube HD 80W-90, 85W-140" title="Mobilube HD 80W-90, 85W-140" align="left" border="0" hspace="0"></em>
                        </p>
                        <h1 xmlns="">Mobilube&trade; HD 80W-90, 85W-140</h1>
                        <p xmlns="">Mobilube HD 80W-90 and 85W-140 are high performance, heavy duty gear lubricants formulated from high performance base oils and an advanced additive system.&nbsp;These lubricants are engineered for automotive applications including heavy duty axles and final drives where extreme pressures and shock loading are expected.&nbsp;They are recommended by ExxonMobil for&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; applications where API GL-5 service is required.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81326a3a', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                    ...
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            ...
                                            <td width="56%" height="" class="standard">
                                                ...
                                                <p>Extended gear and bearing life due to minimal deposits<br>
            Longer seal life</p>
                                        ...
                                        <tr>
                                            <td width="56%" height="" class="standard">
                                                ...
                                                <p>Outstanding protection against low speed/high torque wear and against high speed scoring</p>
            ...
            Reduced maintenance costs and longer equipment life</p>
                                        ...
                                        <tr>
                                            <td width="56%" height="" class="standard">
                                                ...
                                                <p>Effective low temperature lubrication</p>
            
                                            </td><td width="43%" height="" class="standard">
            
                                                <p>Improved startability</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    ...
                                    <ul xmlns="">
                                        ...
                                        <li>Heavy duty axles and final drives requiring API GL-5 level performance</li>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="75%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobilube HD Gear Oils meet or exceed the requirements of the following industry specification:</strong>
                                                    </p>
                                                </th><th width="11%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>80W-90</strong>
                                                    </p>
                                                </th><th width="12%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>85W-140</strong>
                                                    </p>
                                                </th>
                                            </tr>
                                        </thead><tbody><tr>
