...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Delvac&trade; Super 1400 15W-40</title>
        <meta name="keywords" content="Mobil Delvac Super 1400 15W-40"/>
        <meta name="description" content="Mobil Delvac&trade; Super 1400 15W-40 - High Performance Diesel Engine Oil"/>
        <meta name="date" content="2012-08-01"/>
        <meta name="WT.ti" content="Mobil Delvac&trade; Super 1400 15W-40"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d80dd0c28");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix">
                <script type="text/javascript">quickEditForm('0915881d80dd0c28','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script>
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d80dd0c28', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div>
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../AP-English-LCW/heavydutyoils_in_rear-axle.aspx"><img width="60" title="rear axle" src="../Shared-Images-LCW/teaser_60x60_axle_gbl.jpg" longdesc="" height="60" border="0" alt="rear axle"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/AP-English-LCW/heavydutyoils_in_rear-axle.aspx">rear axle</a>
                        </h2>
                        <div class="relatedContent">&nbsp;</div>
                    </div>
                </div>
                <div id="mainContent_thin">
                    <script type="text/javascript">quickEditForm('0915881d80dd0c28', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script>
                    <div id="topSec">
                        <div style="float:left" id="flash"><img xmlns="" src="../AP-English-LCW/Images/product_120x150_mobil-delvac-super-1400-15w40_in.jpg" height="150" width="120" alt="Mobil Delvac Super 1400 15W-40" title="Mobil Delvac Super 1400 15W-40" align="left" border="0" hspace="0"> </div>
                        <h1>Mobil Delvac&trade; Super 1400 15W-40</h1>
                        <p xmlns="">Mobil Delvac Super 1400 15W-40 is a high performance diesel engine oil that provides proven protection of diesel engines operating on and off-highway severe service applications. Mobil Delvac Super 1400 15W-40 is recommended by ExxonMobil for use in a wide range of heavy-duty applications and operating environments found in the trucking, mining, construction, quarrying, and agricultural industries.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5">
                                <script type="text/javascript">quickEditForm('0915881d80dd0c28', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script>
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">The technology in Mobil Delvac Super 1400 15W-40 delivers excellent performance in both modern diesel engines as well as older models. The key benefits include:</p>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="100%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobil Delvac Super 1400 15W-40 meets or exceeds the requirements of the following industry specifications</strong>
                                                    </p>
                                                </th>
                                            </tr>
                                        </thead><tbody><tr>
                                    ...
                                    <table width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="100%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobil Delvac Super 1400 15W-40 has the following builder approvals</strong>
                                                    </p>
                                                </th>
                                            </tr>
                                        </thead><tbody><tr>
                                    ...
                                    <table width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="100%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobil Delvac Super 1400 15W-40 is recommended by ExxonMobil for use in applications requiring:</strong>
                                                    </p>
                                                </th>
                                            </tr>
                                        </thead><tbody><tr>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="78%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobil Delvac Super 1400 15W-40</strong>
                                                    </p>
