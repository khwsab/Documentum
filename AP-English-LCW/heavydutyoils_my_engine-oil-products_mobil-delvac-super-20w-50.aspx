...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Delvac Super&trade; 20W-50 - Malaysia | Mobil&trade; Asia Pacific</title>
        <meta name="keywords" content="Mobil Delvac Super 20W-50"/>
        <meta name="description" content="Mobil Delvac Super&trade; 20W-50"/>
        <meta name="date" content="2012-08-01"/>
        <meta name="WT.ti" content="Mobil Delvac Super&trade; 20W-50 - Malaysia | Mobil&trade; Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d80dd5270");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix">
                <script type="text/javascript">quickEditForm('0915881d80dd5270','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script>
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d80dd5270', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div>
                ...
                <div id="mainContent_thin">
                    <script type="text/javascript">quickEditForm('0915881d80dd5270', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script>
                    <div id="topSec">
                        <div style="float:left" id="flash"> </div>
                        <p xmlns="">
                            <em><img src="../AP-English-LCW/Images/product_120x150_mobil_delvac-super-20w50_my.jpg" height="150" width="120" alt="Mobil Delvac Super 20W-50" title="Mobil Delvac Super 20W-50" align="left" border="0" hspace="0"></em>
                        </p>
                        <h1>Mobil Delvac Super&trade; 20W-50</h1>
                        <p>Mobil Delvac Super 20W-50 is a high performance, heavy duty engine oil that provides proven protection to diesel engines operating in severe on and off-highway service applications.&nbsp;Mobil Delvac Super 20W-50 is recommended for use in a wide range of heavy duty applications and operating environments found in the trucking, construction, and agricultural industries.<span>&nbsp;&nbsp; It is&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;also suitable for gasoline engines.</span>
                        </p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5">
                                <script type="text/javascript">quickEditForm('0915881d80dd5270', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="100%" scope="col" height="" class="standard">
                                                    <p>
                                                        <strong>Mobil Delvac Super 20W-50 is recommended by ExxonMobil for use in applications requiring</strong>
                                                    </p>
                                                </th>
                                            </tr>
                                        </thead><tbody><tr>
