...
<%@ Register Src="Navigation/industrialspeciality.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Industrial Oils &amp; Specialty Lubricants | Mobil Asia Pacific</title>
        <meta name="keywords" content="industrial oil, industrial lubrication, industrial lubricant"/>
        <meta name="description" content="Information on industrial oils, industrial lubricants and industrial lubrication services including marine and avaiation lubricants, petroleum specialties and signmum oil analysis."/>
        <meta name="WT.ti" content="Industrial Oils &amp; Specialty Lubricants | Mobil Asia Pacific"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d80c1f14d");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix">
                <script type="text/javascript">quickEditForm('0915881d80c1f14d','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script>
                <div id="sideBar" class="clrfix"><xom:Navigation ID="LeftNav" runat="server" /><!--#include file="Navigation/QuickLinks_industrialspeciality.aspx"--></div>
                <div id="mainContent"><div class="layoutRow clrfix">
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d80c1f14d", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div>
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft">
                            <script type="text/javascript">quickEditForm("0915881d80c1f14d", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script>
                        </div>
                        <div class="subfeature csingle cright">
                            <script type="text/javascript">quickEditForm("0915881d80c1f14d", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script>
                        </div>
                    </div>
                </div>
