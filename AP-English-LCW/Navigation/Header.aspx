...
<div id="globalHeader" class="clrfix">
    <script type="text/javascript">quickEditForm("0915881d81fe829c", "/Content/Logo",false,"../forms/LCWHeaderLogo","","625px","500px","Header Logo","","pencil.gif","");</script><a onclick="trackClick(this);" href="/AP-English-LCW/default.aspx"><img title="" src="/Shared-Images-LCW/headerlogo_86x30_mobil-logo_gbl.jpg" longdesc="" id="logo" border="0" alt="Mobil logo 1"></a>
    ...
    <div style="visibility: Visible; display:none;" id="search">
        <form onsubmit="javascript: return CheckInput()" name="frmSimpleSearch" method="get" action="/Search/Search.aspx">
            <div>
                <script type="text/javascript">quickEditForm("0915881d81fe829c", "/Content",true,"../forms/LCWHeaderSettings","","630px","700px","Search And Language Settings","","pencil.gif","");</script><span style="padding-right:30px" class="barbgleftSumbitOff"><span class="barbgrightSubmitOff">&nbsp;</span></span><label for="searchTerms">SEARCH</label><input value="keywords" type="text" onClick="javascript: clearBox();" name="q" maxlength="50" id="qt"><input value="mobil|ledr" type="hidden" name="site"><input value="/imports/lcw_xom" type="Hidden" name="css"><input type="hidden" name="BCL" value="/AP-English-LCW/Navigation"><input value="global" type="Hidden" name="km"><input value="en" type="hidden" name="la"><input value="lang_en" type="hidden" name="lr"><input value="xml_no_dtd" type="Hidden" name="output"><input value="default_frontend" type="Hidden" name="client"><input value="description" type="Hidden" name="getfields"><input value="n" type="Hidden" name="show_km"><input value="inurl:mobil inurl:/AP-English-LCW OR inurl:/AP-English/Lubes/PDS" type="hidden" name="as_q"><input value="0" type="Hidden" name="filter"><input value="10" type="Hidden" name="num"><input value="UTF-8" type="Hidden" name="ie"><input value="UTF-8" type="Hidden" name="oe"><span class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="SEARCH" type="submit" class="middleSubmitBtn"></span></span>
            </div>
        </form>
    </div>
    <div id="globalNav">
        <ul class="clrfix">
            <script type="text/javascript">quickEditForm("0915881d81fe829c", "/Content/UtilityControls",true,"../forms/LCWHeaderUtilNav","","680px","700px","Utility Navigation","","pencil.gif","");</script>
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("AP-English-LCW/default.aspx") %> href="/AP-English-LCW/default.aspx">home</a></li>
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("AP-English-LCW/news.aspx") %> href="/AP-English-LCW/news.aspx">news</a></li>
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("http://ir.exxonmobil.com") %> href="http://ir.exxonmobil.com">investors</a></li>
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("http://www.mobil.com/AP-English-LCW/careers.aspx") %> href="http://www.mobil.com/AP-English-LCW/careers.aspx">careers</a></li>
...
<div style="z-index:450;">
    <script type="text/javascript">quickEditForm("0915881d81fe829c", "/Content/Top_Navigation",true,"../forms/LCWHeaderTopNav","","680px","700px","Top Navigation","","pencil.gif","");</script>
</div>
<div id="mainNav" class="clrfix">
    <div id="BlueNavPanel_Current_2">
        ...
        <div class="navBarLeft">
            <ul>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/carengineoils.aspx" id="carengineoils">car engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/heavydutyoils.aspx" id="heavydutyoils">heavy duty engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/industrialspecialty.aspx" id="industrialspecialty">industrial &amp; specialty lubricants</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/wheretobuy.aspx" id="wheretobuy">where to buy</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/mobilbrands.aspx" id="mobilbrands">Mobil brands</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/AP-English-LCW/fuels.aspx" id="fuels">fuels</a>
                </li>
            </ul>
        </div>
