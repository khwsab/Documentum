...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Videos | Mobil Asia Pacific</title>
        <meta name="keywords" content="Mobil Delvac, News and Events, Resource Centre, downloads"/>
        <meta name="description" content="Mobil Delvac resource centre. Find latest downloads, videos, news and wallpapers from Mobil Delvac."/>
        <meta name="WT.ti" content="Videos | Mobil Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d80c1a2c6");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix">
                    <script type="text/javascript">quickEditForm('0915881d80c1a2c6','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script>
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px">
                            <script type="text/javascript">quickEditForm("0915881d80c1a2c6", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script>
                        </div>
                        <div style="float:left;width:201px">
                            <script type="text/javascript">quickEditForm("0915881d80c1a2c6", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script>
                        </div>
                    </div>
                    <div id="mainContent_thin">
                        <script type="text/javascript">quickEditForm("0915881d80c1a2c6", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script>
                        <div id="flashvidpad">
                            <div id="flashVideoTop"/>
                        </div>
                        <p/>
                        <h1>Videos</h1>
                        <p xmlns="">Click on the thumbnails below to find the latest information from <em>Mobil</em>.</p>
                        <p>
                            <img src="../AP-English-LCW/Images/carousel_76x60_mobil-delvac-moeller-video.jpg" height="60" width="75" alt="Rely on Mobil Delvac" title="Rely on Mobil Delvac" align="middle" border="0" hspace="0">&nbsp;Rely on Mobil Delvac</p>
                        <p>
                            <img src="../AP-English-LCW/Images/carousel_76x60_mobil-delvac-hastings-video.jpg" height="60" width="76" alt="Landscaper" title="Landscaper" align="middle" border="0" hspace="0">&nbsp;Landscaper</p>
                    </div>
                </div>
