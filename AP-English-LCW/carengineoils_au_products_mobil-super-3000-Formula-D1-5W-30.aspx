...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super 3000 Formula D1 5W-30 - Australia | Mobil&trade; Asia Pacific</title>
        <meta name="keywords" content="Mobil Super 3000 Formula D1 5W-30"/>
        <meta name="description" content="Mobil Super 3000 Formula D1 5W-30 is a full synthetic high-performance motor oil, which provides excellent high temperature protection even under severe operating conditions."/>
        <meta name="date" content="2015-07-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super 3000 Formula D1 5W-30 - Australia | Mobil&trade; Asia Pacific"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81952b08");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81952b08','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81952b08', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81952b08', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../AP-English-LCW/Images/product_120x150_Mobil-Super-3000-Formula-D1-5W-30.jpg" alt=" Mobil Super 3000 Formula D1 5W-30 " title=" Mobil Super 3000 Formula D1 5W-30 " align="left"> </div>
                        <h1>Mobil &trade; Super 3000 Formula D1 5W-30</h1>
                        <p xmlns="">Mobil Super 3000 Formula D1 5W-30 is a full synthetic high-performance motor oil, which provides excellent high temperature protection even under severe operating conditions.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81952b08', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">The oil is designed to help provide long engine life and outstanding protection in vehicles of all ages, outperforming our conventional-synthetic blended products. It provides outstanding protection against sludge, engine rust and corrosion under severe and low-temperature operating conditions and provide optimum viscosity and fluidity across a broad range of temperatures.</p>
                                    <p xmlns="">Mobil Super 3000 Formula D1 5W-30 is classified by The American Petroleum Institute (API) as "Resource Conserving" engine lubricants and meet or exceed ILSAC GF-5. Those claims are backward compatible with earlier performance levels such as API SN, SM and previous ILSAC categories.</p>
                                    <p xmlns="">Mobil Super 3000 Formula D1 5W-30 is approved against General Motors dexos1&trade; under the license GB1D1010015.</p>
                                    <ul xmlns="">
                                        ...
                                        <li>Protection beyond our conventional-synthetic blended products</li>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil Super 3000 Formula D1 5W-30 is recommended for gasoline fueled automobiles and light duty trucks requiring an API SN, SM. It meets ILSAC GF-5 (Starburst Certification Symbol).</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <b>Mobil Super 3000 Formula D1 5W-30 meets or exceeds the requirements of: </b>
                                        <br>
API SN / SM <br>
ILSAC GF-5</p>

                                    <p xmlns="">Mobil Super 3000 Formula D1 is recommended by ExxonMobil for use in applications requiring General Motors Service Fill dexos1&trade; (license number GB1D1010015.)</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Properties Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="291" scope="col" height="25" class="standard">
            
                                                    <p>Mobil Super 3000 Formula D1 5W-30</p>
            
                                                </th><th width="114" scope="col" height="" class="standard">&nbsp;</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="291" height="27" class="standard">
            
                                                <p>API Service Classification</p>
