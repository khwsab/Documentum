...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81952a68");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81952a68','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81952a68', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81952a68', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../AP-English-LCW/Images/product_120x150_mobil-1-0w20_au.jpg" alt="Mobil 1 0W-20" title="Mobil 1 0W-20" align="left"> </div>
                        <h1>Mobil 1&trade; 0W-20</h1>
                        <p xmlns="">Mobil 1&trade; 0W-20 is an advanced full synthetic engine oil designed to help deliver outstanding engine protection and enhanced fuel economy. Mobil 1 0W-20 meets or exceeds the requirements of various vehicle manufacturers and industry standards and outperforms conventional oils. Mobil 1 0W-20 is recommended for SAE 0W-20 and 5W-20 applications.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81952a68', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">Mobil 1 0W-20 is engineered with a proprietary blend of high performance synthetic basestocks fortified with a precisely balanced component additive system. The low viscosity, advanced full synthetic formulation helps to increase engine efficiency and improve fuel economy. Mobil 1 0W-20 provides the high-temperature protection of higher viscosity oils while offering the best fuel economy in the Mobil 1 line.</p>
                                    <ul xmlns="">
                                        <li>Helps improve fuel economy based on 0.2-2.3% potential fuel economy improvement obtained by switching from higher viscosity oils to a 0W-20 grade. Actual savings are dependent upon vehicle/engine type, outside temperature, driving conditions and your current engine oil viscosity</li>
                                        <li>Helps to reduce oil aging resulting in long lasting protection</li>
                                        <li>Outstanding low temperature capabilities</li>
                                        <li>Quick cold weather starting and fast protection helps to extend engine life</li>
                                        <li>Excellent overall lubrication and wear protection performance for many driving styles and conditions, from mild to severe, where a 5W-20 or 0W-20 is recommended</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil 1 0W-20 is recommended by ExxonMobil for SAE 5W-20 and 0W-20 applications in all types of gasoline fueled passenger cars, SUV&rsquo;s, vans, and light trucks.</p>
                                    <ul xmlns="">
                                        <li>Mobil 1 0W-20 is engineered to help deliver outstanding engine protection and fuel economy benefits.</li>
                                        <li>Mobil 1 0W-20 is recommended for extreme cold conditions to help deliver quick starts and fast lubrication.</li>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <b>Mobil 1 0W-20 meets or exceeds the requirements of: </b>
                                        <br>
API SN,SM,SL,SJ <br>
ILSAC GF-5 <br>
Ford WSS-M2C947-A</p>
                                    ...
                                    <p xmlns="">
                                        <b>Mobil 1 0W-20 has the following builder approvals: </b>
                                        <br>
General Motors Service Fill dexos1&trade; (license number GB1D0415015)</p>

                                    <p xmlns="">
                                        <b>According to ExxonMobil, Mobil 1 0W-20 is of the following quality level: </b>
                                        <br>
...
API CF</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Properties Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="291" scope="col" height="25" class="standard">&nbsp;</th><th width="114" scope="col" height="" class="standard">
