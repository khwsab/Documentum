...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="no" lang="no">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; i Norge | Motorolje for biler | Mobil Super 3000&trade; Formula P 0W-30</title>
        <meta name="keywords" content="Mobil Super 3000 Formula P, mobil 1 esp, mobile, motoroil, engine lubes, mobile, synthetic, syntetic, synthetics, lubricants, lubes, lubrication, oils, grease, greaze, mobil , exxonmobil , exxon , Mobil1 , Mobil 1 , BP , Shell , motorsport , F1 , Formula 1 , Lewis Hamilton , McLaren , castrol"/>
        <meta name="description" content="&nbsp;Mobil Super 3000 Formula P, mobil 1 esp, mobile, motorolje, smøremidler motor, mobile, syntetisk olje, syntetisk, syntetiske, smøremidler, smøring, olje, smørefett, grease, mobil , exxonmobil , exxon , Mobil1 , Mobil 1 , BP , Shell , motorsport , F1 , Formel 1 , Lewis Hamilton , McLaren , castrol"/>
        <meta name="date" content="2014-01-01"/>
        <meta name="language" content="no"/>
        <meta http-equiv="Content-Language" content="no"/>
        <meta name="WT.ti" content="Mobil&trade; i Norge | Motorolje for biler | Mobil Super 3000&trade; Formula P 0W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d817b21ab");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d817b21ab','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d817b21ab', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d817b21ab', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d817b21ab', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fordeler Content">
                                    <p xmlns="">Mobil Super 3000 Formula P 0W-30 gir utmerket slitasjebeskyttelse og motorrenhet ved høye og lave temperaturer.</p>

                                    <p xmlns="">Egenskaper og fordeler:</p>

                                    <ul xmlns="">
    
                                        <li>Lavt aske-, fosfor- og svovelinnhold bidrar til å forlenge levetiden og opprettholde effektiviteten til utslippsreduksjonssystemer i både diesel- og bensinmotorer.</li>
    
                                        <li>Oljen er fullt forenlig med de fleste dieselpartikkelfiltre og bensinkatalysatorer.</li>
    
                                        <li>Bidrar til å oppnå drivstofføkonomi (etter ACEA C2).</li>
    
                                        <li>Veldig gode egenskaper ved lave temperaturer sørger for pålitelig oppstart i kaldt vær og hurtig beskyttelse av motoren og det elektriske systemet.</li>
    
                                        <li>Slitasjebeskyttelse på høyt nivå.</li>
    
                                        <li>Aktive rensemidler gir mindre avleiringer og slamdannelse, samt en ren og lang levetid på motoren.</li>

                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Bruksområder Content">
                                    <p xmlns="">Mobil Super 3000 Formula P 0W-30 kan brukes til alle diesel- og bensinmotorer som krever Peugeot Citroën B71 2312.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Spesifikasjoner Content">
                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula P 0W-30 møter eller overgår følgende industrispesifikasjoner:&nbsp;&nbsp; </strong>
                                        <br>
ACEA C2</p>
                                    ...
                                    <p xmlns="">
                                        ...
                                        <strong>Mobil Super 3000 Formula P 0W-30 har følgende utstyrsprodusentgodkjennelser:&nbsp;&nbsp;&nbsp;</strong> 
                                        <br>
Peugeot Citroën Automobiles PSA B71 2312 <br>
&nbsp;</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Egenskaper Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">cSt ved 40 ºC</td><td width="" height="" class="standard">51,8</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cSt ved 100 ºC</td><td width="" height="" class="standard">9,7</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Sulfatert aske, vkt%, ASTM D 874</td><td width="" height="" class="standard">0,5</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Fosfor</td><td width="" height="" class="standard">0,06</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Flammepunkt, °C, ASTM D 92</td><td width="" height="" class="standard">234</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Tetthet ved 15 ºC kg/l, ASMT D 4052</td><td width="" height="" class="standard">0,84</td>
                                        </tr>
                                        <tr>
