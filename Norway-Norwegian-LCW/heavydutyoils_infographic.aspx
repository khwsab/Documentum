...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Redusere drivstofforbruk og utslippsnivåer</title>
        <meta name="keywords" content="Mobil Delvac, Mobil Delvac 1, Mobil Delvac 1™ LE 5W-30, drivstofforbruk, utslippsnivåer, CO2-reduksjon"/>
        <meta name="description" content="Motoroljen Mobil Delvac 1™ LE 5W-30 hjelper dansk transportselskap med å oppnå en gjennomsnittlig drivstoffbesparelse på 3,4 %"/>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
					...
					<div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="pop/infographic-widget/index-no-spf-danmark.html" width="690" height="2400" frameborder="0"></iframe></p> </div>
				</div>
