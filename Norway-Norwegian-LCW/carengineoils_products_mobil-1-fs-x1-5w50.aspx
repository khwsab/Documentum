...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="no" lang="no">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="description" content="Mobil 1&trade; er verdens ledende merke innen syntetisk motorolje, og gir optimal ytelse og beskyttelse."/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81edaef0");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81edaef0','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81edaef0', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81edaef0', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil 1&trade; er verdens ledende merke innen syntetisk motorolje, og gir optimal ytelse og beskyttelse.&nbsp; Mobil 1-teknologien sørger for at motoren holdes i like god stand som da den var ny. Mobil 1&trade; FS x1 5W-50 er en avansert, syntetisk motorolje som er utviklet for å gi eksepsjonell renseevne.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81edaef0', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fordeler Content">
                                    <p xmlns="">Mobil 1 &trade; FS x1 5W-50 er fremstilt av en proprietær blanding av høytytende syntetiske baseoljer som er forsterket med et nøyaktig balansert komponentsystem. Oljen gir følgende:</p>

                                    <p xmlns="">&nbsp;</p>

                                    <ul xmlns="">
    
                                        <li>Slitasjebeskyttelse for motoren over hele oljeskiftintervallet.</li>
    
                                        <li>Utmerket beskyttelse av motoren ved å bidra til å hindre opphopning av skadelige avleiringer.&nbsp;&nbsp;&nbsp;&nbsp;</li>
    
                                        <li>Forbedret renseteknologi for biler med høy kjørelengde, dvs. mer enn 100 000 km.</li>
    
                                        <li>Bedre beskyttelse mot variabel drivstoffkvalitet*</li>
    
                                        <li>Beskyttelse av motoren ved oppstart i lave temperaturer.</li>

                                    </ul>

                                    <p xmlns="">* Sammenlignet ytelse i bransjestandardtester hvor det brukes drivstoff som er utviklet for å fremme slamdannelse.<br>
&nbsp;</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Bruksområder Content">
                                    <p xmlns="">Mobil 1 FS x1 5W-50 anbefales for mange typer biler med høy kjørelengde (&gt; 100 000 km).</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Spesifikasjoner Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 tilfredsstiller eller overgår kravene til:</strong>
                                        <br>
API, SN, SM<br>
ACEA A3/B3, A3/B4<br>
&nbsp;</p>
                                    ...
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 har følgende utstyrsprodusentgodkjennelser:</strong>
                                        <br>
MB-godkjennelse 229.1<br>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Egenskaper Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            ...
                                            <td width="" height="" class="standard">&nbsp;Viskositet ved 40 ºC (ASTM D445)&nbsp;</td><td width="" height="" class="standard">101&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Flammepunkt, ºC (ASTM D 92)</td><td width="" height="" class="standard">&nbsp;239</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Stivnepunkt, ºC (ASTM D 97)</td><td width="" height="" class="standard">&nbsp;-45</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Densitet ved 15 ºC, g/ml (ASTM D4052)&nbsp;&nbsp;</td><td width="" height="" class="standard">&nbsp;0.85</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
