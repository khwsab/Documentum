    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                            ...
                            <asp:panel visible="false" id="L1_1_L2_1_L3_1" Runat="server">
                                <ul>
                                    ...
                                    <asp:panel visible="false" id="L1_1_L2_1_L3_1_L4_1" Runat="server">
                                        <ul>
                                            <li class="endpoint">
                                                <asp:HyperLink runat="server" id="aL1_1_L2_1_L3_1_L4_1" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_products_engine-oils_mobil-delvac-1-le-5w30-faqs.aspx">Mobil Delvac 1  LE 5W-30 - Vanliga frågor och svar</asp:HyperLink>
                                            </li>
                    ...
                    <asp:panel visible="false" id="L1_1_L2_4" Runat="server">
                        <ul>
                            <li>
                                <asp:HyperLink runat="server" id="aL1_1_L2_4" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_products_rear-axle.aspx">bakaxelsmörjmedel</asp:HyperLink>
                            </li>
                    ...
                    <asp:panel visible="false" id="L1_1_L2_5" Runat="server">
                        <ul>
                            <li>
                                <asp:HyperLink runat="server" id="aL1_1_L2_5" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_products_transmission.aspx">manuella och automatiska växellådor</asp:HyperLink>
                            </li>
            ...
            <asp:panel visible="true" id="L1_2" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_2" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_mobil-delvac-product-selector.aspx">Mobil Delvac produktväljare</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_4" Runat="server">
                <ul>
                    <li>
                        <asp:HyperLink runat="server" id="aL1_4" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_why.aspx">varför Mobil Delvac</asp:HyperLink>
                    </li>
                    <asp:panel visible="false" id="L1_4_L2_1" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_4_L2_1" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_why_fuel-economy.aspx">bränsleekonomi</asp:HyperLink>
                            </li>
                    ...
                    <asp:panel visible="false" id="L1_4_L2_3" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_4_L2_3" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_why_emissions.aspx">utsläpp</asp:HyperLink>
                            </li>
                    ...
                    <asp:panel visible="false" id="L1_4_L2_4" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_4_L2_4" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_why_synthetics.aspx">varför syntestiska smörjmedel</asp:HyperLink>
                            </li>
            ...
            <asp:panel visible="true" id="L1_5" Runat="server">
                <ul>
                    <li>
                        <asp:HyperLink runat="server" id="aL1_5" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_mobil-delvac-fuel-saving-millbrook.aspx">2,9 % bränslebesparing</asp:HyperLink>
                    </li>
                    ...
                    <asp:panel visible="false" id="L1_5_L2_2" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_5_L2_2" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_mobil-delvac-fuel-economy.aspx">Mobil Delvac bränsleekonomi</asp:HyperLink>
                            </li>
            ...
            <asp:panel visible="true" id="L1_6" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_6" NavigateUrl="/Sweden-Swedish-LCW/heavydutyoils_mobil-delvac-synthetic-atf-allison-tes-approved.aspx">Allison TES 295-godkänd</asp:HyperLink>
                    </li>
