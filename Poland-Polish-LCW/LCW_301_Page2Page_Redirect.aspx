...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81edb46b");</script>
        </div>
...
<%if(current_url_path.IndexOf("wip") <0){%>
       ...
       <p style="color:red; font-weight:bold;"><br /><br />Incorrect redirect URL</p> 
      <p>Please edit the redirect URL. Use fully qualified URL starting with http://www<br />
          Example: http://www.exxonmobil.com</p>
<%}else{%>    
          
      <p style="color:red; font-weight:bold;"><br /><br />Incorrect redirect URL</p> 
          <p>Please edit the redirect URL using the pencil below. Use fully qualified URL starting with http://www<br />
          Example: http://www.exxonmobil.com</p>
          <p><b><a target="_blank" href=""></a></b>&#160;&#160;
<script type="text/javascript">quickEdit("0915881d81edb46b","/page/RedirectURL","textline","Enter Redirect URL","","pencil.gif","","");</script></p>
