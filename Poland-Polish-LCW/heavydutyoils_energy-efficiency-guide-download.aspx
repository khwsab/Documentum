...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pl" lang="pl">
    <head><meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Download Your EEG &ndash; Pobierz swój EEG</title>
        <meta name="keywords" content="Download Your EEG &ndash; Pobierz swój EEG"/>
        <meta name="description" content="Download Your EEG &ndash; Pobierz swój EEG"/>
        <meta name="date" content="2016-11-01"/>
        <meta name="language" content="pl"/>
        <meta http-equiv="Content-Language" content="pl"/>
        <meta name="WT.ti" content="Download Your EEG &ndash; Pobierz swój EEG"/>
    ...
    <body class="landing">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d82017bf8");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d82017bf8','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d82017bf8", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <h1>Download Your EEG &ndash; Pobierz swój EEG</h1>
                        <p xmlns="">Mo&#380;esz pobra&#263; <a title="This link will open a new window." target="_blank" onclick="trackClick(this);" href="/Poland-Polish-LCW/Files/Poland_Energy_Efficiency_Guide_amended_v2.pdf">EEG tutaj<img src="/Images/Icons/icon_pdf_whitespace.jpg" border="0" alt=""></a>
                        </p>

                        <p xmlns="">
                            <a title="This link will open a new window." target="_blank" onclick="trackClick(this);" href="/Poland-Polish-LCW/Files/PL-eeg-version-without-McLaren.pdf"><img src="../Poland-Polish-LCW/Images/Energy_Efficiency_Guide_Banner_PL.jpg" height="269" width="440"></a>
                        </p> </div>
                        ...
                        <div class="frame01TR"></div>
                            ...
                            <div class="frame01BR clrfix">
                                <div style="padding-right: 55px;" class="content">
                                    <h2>
                                        <a xmlns="" title="This link will open a new window." target="_blank" onclick="trackClick(this);" href="https://www.mobil.com/en/industrial/lubricants-distributors/externallocator?culture=pl-pl&amp;rendermap=true&amp;renderbutton=false">Lokalizator <br>
dystrybutorów<span></span></a>
                                    </h2>
                                    <p xmlns="">Znajd&#378; najbli&#380;szego <br>
dystrybutora</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="background-image:url(/Shared-Images-LCW/callout_224x135_mobil-delvac-lorry_eame.jpg);" class="callout">
                        ...
                        <div class="frame01TR"></div>
                            ...
                            <div class="frame01BR clrfix">
                                <div style="padding-right: 55px;" class="content">
                                    <h2>
                                        <a xmlns="" title="" target="_self" onclick="trackClick(this);" href="../Poland-Polish-LCW/heavydutyoils_which-oil.aspx">Mobil Delvac - <br>
produkt selektor<span></span></a>
                                    </h2>
                                    <p xmlns="">Dobierz odpowiedni olej <br>
do Twojego samochodu <br>
dostawczego, ci&#281;&#380;arowego <br>
czy innych pojazdów <br>
u&#380;ytkowych</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82017bf8", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82017bf8", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                </div>
