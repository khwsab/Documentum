...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pl" lang="pl">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; w Polsce | Silnikowe oleje samochodowe | Mobil 1&trade;</title>
        <meta name="keywords" content="Syntetyczne oleje, oleje mobil 1, mobile, olej silnikowy, silnikowe &#347;rodki smarne, syntetyczny, syntetyki, syntetyk, oleje smarne, smarowanie, oleje, smar, mobil, exxonmobil, Mobil 1, Mobil 1 0W-40, BP, Shell, castrol, najlepszy olej do silnika."/>
        <meta name="description" content="Szukasz w&#322;a&#347;ciwego oleju do Twojego slnika? Poznaj pe&#322;en asortyment doskona&#322;ych samochodowych olejów silnikowych Mobil&trade;."/>
        <meta name="date" content="2012-01-01"/>
        <meta name="language" content="pl"/>
        <meta http-equiv="Content-Language" content="pl"/>
        <meta name="WT.ti" content="Mobil&trade; w Polsce | Silnikowe oleje samochodowe | Mobil 1&trade;"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81ed480a");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81ed480a','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ed480a", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ed480a", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d81ed480a", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                        ...
                        <h1>Mobil 1&trade;</h1>
                        <p xmlns="">
                            <a title="" target="" onclick="trackClick(this);" href="/POland-Polish-LCW/carengineoils_products_mobil-1-fs-0w40.aspx" class=""><img src="../Shared-Images-LCW/teaser_60x60_mobil-1_fs_0w40.png" height="60" width="60" alt="Mobil 1 FS 0W-40" title="Mobil 1 FS 0W-40" align="middle" border="0" hspace="0">Mobil 1&trade; FS 0W-40</a>
                        </p>
