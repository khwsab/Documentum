<%@ Control Language="C#" AutoEventWireup="true" Inherits="xom.crown.nav.DynamicNavigation" %><script xmlns:asp="http://schemas.microsoft.com/ASPNET/20" type="text/javascript">
		...
		document.getElementById('industrialspecialty').setAttribute("class","mnNavOn");
		document.getElementById('industrialspecialty').className = "mnNavOn";
		
		addFallback(-1,document.getElementById('industrialspecialty').href);
		document.getElementById('navTitle').innerHTML = document.getElementById('industrialspecialty').innerHTML;
    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/Poland-Polish-LCW/industrialspecialty.aspx">przemys&#322;owe &#347;rodki smarne i produkty specjalne</asp:HyperLink>
                    </li>
