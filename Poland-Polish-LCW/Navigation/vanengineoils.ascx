    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-city-logistics-p-5w-30.aspx">Mobil Delvac City Logistics P 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_2" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_2" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-city-logistics-f-5w-30.aspx">Mobil Delvac City Logistics F 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_3" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_3" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-city-logistics-v-5w-30.aspx">Mobil Delvac City Logistics V 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_4" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_4" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-city-logistics-m-5w-30.aspx">Mobil Delvac City Logistics M 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_5" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_5" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-city-logistics-r-5w-30.aspx">Mobil&nbsp;Delvac City Logistics R 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_6" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_6" NavigateUrl="/Poland-Polish-LCW/vanengineoils_mobil-delvac-light-commercial-vehicle-e-10w-40.aspx">Mobil Delvac Light Commercial Vehicle E 10W-40 </asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_7" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_7" NavigateUrl="/Poland-Polish-LCW/heavydutyoils_which-oil.aspx">Mobil Delvac - produkt selektor</asp:HyperLink>
                    </li>
                </ul><% Response.Write((aL1_7.CssClass == "selected") ? "<script type=\"text/javascript\">addFallback(1,\"heavydutyoils_which-oil.aspx\")</script>" : ""); %></asp:panel>
            <div class="capBL">
                <div class="capBR"></div>
            </div>
        </div>
