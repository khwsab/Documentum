    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_2" Runat="server">
                <ul>
                    <li>
                        <asp:HyperLink runat="server" id="aL1_2" NavigateUrl="/Poland-Polish-LCW/heavydutyoils_products.aspx">produkty Mobil Delvac do silnik�w</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_7" Runat="server">
                <ul>
                    <li>
                        <asp:HyperLink runat="server" id="aL1_7" NavigateUrl="/Poland-Polish-LCW/heavydutyoils_national-mechanics-championship-2019.aspx">mistrzostwa mechanik�w 2019</asp:HyperLink>
                    </li>
                    <asp:panel visible="false" id="L1_7_L2_1" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_7_L2_1" NavigateUrl="/Poland-Polish-LCW/heavydutyoils_national-mechanics-championship-2018.aspx">mistrzostwa mechanik�w 2018</asp:HyperLink>
                            </li>
                    ...
                    <asp:panel visible="false" id="L1_7_L2_2" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_7_L2_2" NavigateUrl="/Poland-Polish-LCW/heavydutyoils_national-mechanics-championship-2017.aspx">mistrzostwa mechanik�w 2017</asp:HyperLink>
                            </li>
