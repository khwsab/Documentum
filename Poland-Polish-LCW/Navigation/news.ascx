<%@ Control Language="C#" AutoEventWireup="true" Inherits="xom.crown.nav.DynamicNavigation" %><script xmlns:asp="http://schemas.microsoft.com/ASPNET/20" type="text/javascript">
		...
		document.getElementById('news').setAttribute("class","mnNavOn");
		document.getElementById('news').className = "mnNavOn";
		
		addFallback(-1,document.getElementById('news').href);
		document.getElementById('navTitle').innerHTML = document.getElementById('news').innerHTML;
