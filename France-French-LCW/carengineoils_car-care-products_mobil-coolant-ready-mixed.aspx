...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; en France | Spécialités automobiles | Mobil&trade; Coolant Ready Mixed -36°C</title>
        <meta name="keywords" content=""/>
        <meta name="description" content=""/>
        <meta name="date" content="2012-01-01"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Mobil&trade; en France | Spécialités automobiles | Mobil&trade; Coolant Ready Mixed -36°C"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81211ab6");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81211ab6','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81211ab6', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../France-French-LCW/carengineoils_car-care-products_mobil-antifreeze-extra.aspx"><img width="60" title="Mobil Antifreeze " src="../Shared-Images-LCW/teaser_60x60_mobil-antifreeze_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Antifreeze "></a> </div>
                        <h2>
                            <a title="" target="_self" href="/France-French-LCW/carengineoils_car-care-products_mobil-antifreeze-extra.aspx">Mobil&trade; Antifreeze Extra</a>
                        </h2>
                        <div class="relatedContent">&#160;</div>
                    </div>
                </div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81211ab6', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash"><img xmlns="" src="../Shared-Images-LCW/product_120x150_mobil-coolant-ready_eame.jpg" height="150" width="120" alt="Mobil Coolant Ready Mixed -36°C" title="Mobil Coolant Ready Mixed -36°C" border="0" hspace="0"> </div>
                        <h1>Mobil&trade; Coolant Ready Mixed -36°C</h1>
                        <p xmlns="">
                            <strong>Liquide de refroidissement haute performance</strong>
                        </p>
                        <p xmlns="">Mobil Coolant Ready Mixed est un liquide de refroidissement haute performance conçu pour apporter une protection efficace lorsque les températures descendent jusqu&rsquo;à -36ºC en hiver. Il s&rsquo;agit d&rsquo;un produit prêt à l&rsquo;emploi qui a été pré-mélangé avec 50% de Mobil<em>&trade; </em>Antifreeze Extra et 50% d&rsquo;eau.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81211ab6', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
