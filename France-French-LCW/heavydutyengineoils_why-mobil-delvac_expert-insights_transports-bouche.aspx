...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Economies de carburant / réduction des émissions</title>
        <meta name="keywords" content="Mobil Delvac, Mobil Delvac 1, Mobil Delvac 1™ LE 5W-30, économies de carburant, lubrifiants Mobil™,  transporteur français, réduction des émissions, réduire les consommations de carburant"/>
        <meta name="description" content="L’huile moteur Mobil Delvac 1™ LE 5W-30 permet à un transporteur français de réaliser des économies de carburant"/>
        <meta name="date" content="2012-01-01"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Mobil&trade; en France | Delvac : Le point de vue des experts |"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8151d7f3");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8151d7f3','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d8151d7f3", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
						<div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="pop/infographic-widget/index-fr-testimonial-bouche.html" width="690" height="2000" frameborder="0"></iframe></p> </div>
