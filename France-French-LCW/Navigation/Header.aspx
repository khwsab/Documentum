...
<div id="globalHeader" class="clrfix">
    <script type="text/javascript">quickEditForm("0915881d81fe92d4", "/Content/Logo",false,"../forms/LCWHeaderLogo","","625px","500px","Header Logo","","pencil.gif","");</script><a onclick="trackClick(this);" href="/France-French-LCW/default.aspx"><img title="" src="/Shared-Images-LCW/headerlogo_86x30_mobil-logo_gbl.jpg" longdesc="" id="logo" border="0" alt="Mobil logo 1"></a>
    ...
    <div style="visibility: Visible;display:none;" id="search">
        <form onsubmit="javascript: return CheckInput()" name="frmSimpleSearch" method="get" action="/Search/Search.aspx">
            <div>
                <script type="text/javascript">quickEditForm("0915881d81fe92d4", "/Content",true,"../forms/LCWHeaderSettings","","630px","700px","Search And Language Settings","","pencil.gif","");</script><span style="padding-right:30px" class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="ouverture de session&nbsp;" type="button" onclick="location.href='/France-French-LCW/login.aspx'" class="middleSubmitBtn"></span></span><label for="searchTerms">RECHERCHER</label><input value="mots-clefs" type="text" onClick="javascript: clearBox();" name="q" maxlength="50" id="qt"><input value="mobil|ledr" type="hidden" name="site"><input value="/imports/lcw_xom" type="Hidden" name="css"><input type="hidden" name="BCL" value="/France-French-LCW/Navigation"><input value="global" type="Hidden" name="km"><input value="fr" type="hidden" name="la"><input value="lang_fr" type="hidden" name="lr"><input value="xml_no_dtd" type="Hidden" name="output"><input value="default_frontend" type="Hidden" name="client"><input value="description" type="Hidden" name="getfields"><input value="n" type="Hidden" name="show_km"><input value="inurl:mobil inurl:/France-French-LCW OR inurl:/France-French/Lubes/PDS" type="hidden" name="as_q"><input value="0" type="Hidden" name="filter"><input value="10" type="Hidden" name="num"><input value="UTF-8" type="Hidden" name="ie"><input value="UTF-8" type="Hidden" name="oe"><span class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="RECHERCHER" type="submit" class="middleSubmitBtn"></span></span>
            </div>
        </form>
    </div>
    <div id="globalNav">
        <ul class="clrfix">
            <script type="text/javascript">quickEditForm("0915881d81fe92d4", "/Content/UtilityControls",true,"../forms/LCWHeaderUtilNav","","680px","700px","Utility Navigation","","pencil.gif","");</script>
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("France-French-LCW/default.aspx") %> href="/France-French-LCW/default.aspx">accueil</a></li>
...
<div style="z-index:450;">
    <script type="text/javascript">quickEditForm("0915881d81fe92d4", "/Content/Top_Navigation",true,"../forms/LCWHeaderTopNav","","680px","700px","Top Navigation","","pencil.gif","");</script>
</div>
<div id="mainNav" class="clrfix">
    <div id="BlueNavPanel_Current_2">
        ...
        <div class="navBarLeft">
            <ul>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/carengineoils.aspx" id="carengineoils">lubrifiants auto</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/vanengineoils.aspx" id="vanengineoils">Véhicules utilitaires légers</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/heavydutyengineoils.aspx" id="heavydutyoils">lubrifiants transports, tp, agri</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/industrialspecialty.aspx" id="industrialspecialty">industrie</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/which-oil.aspx" id="which-oil">quelle huile</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/buy.aspx" id="wheretobuy">points de vente</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/fuels.aspx" id="fuels">carburants</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/France-French-LCW/mobil-brands.aspx" id="mobilbrands">marques Mobil</a>
                </li>
            </ul>
        </div>
