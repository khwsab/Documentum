    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li>
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/France-French-LCW/heavydutyengineoils.aspx">Mobil Delvac pour moteurs à usage intensif</asp:HyperLink>
                    </li>
                    ...
                    <asp:panel visible="false" id="L1_1_L2_2" Runat="server">
                        <ul>
                            <li class="endpoint">
                                <asp:HyperLink runat="server" id="aL1_1_L2_2" NavigateUrl="/France-French-LCW/heavydutyengineoils_why-mobil-delvac.aspx">Pourquoi choisir Mobil Delvac ?Pourquoi choisir Mobil Delvac ?</asp:HyperLink>
                            </li>
                        </ul><% Response.Write((aL1_1_L2_2.CssClass == "selected") ? "<script type=\"text/javascript\">addFallback(2,\"heavydutyengineoils_why-mobil-delvac.aspx\")</script>" : ""); %></asp:panel>
