...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>économies de carburant / réduction des émissions</title>
        <meta name="keywords" content="Mobil Delvac 1 LE 5W-30, réduction des émissions, réduire les émissions de CO2, Mobil Delvac, Mobil Delvac 1, transporteur danois"/>
        <meta name="description" content="L’huile moteur Mobil Delvac 1™ LE 5W-30 contribue à réduire la consommation de carburant d’un transporteur danois"/>
            ...
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    ...
                    <div id="mainContent_thin"><!-- googleoff: all -->
						...
						<div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="pop/infographic-widget/index-fr-spf-danmark.html" width="690" height="2200" frameborder="0"></iframe></p> </div>
