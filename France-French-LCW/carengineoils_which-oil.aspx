...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Mobil&trade; en France | Outil de préconisation d&rsquo;huiles moteur | Trouvez la bonne huile pour votre voiture, camion, véhicule utilitaire, véhicules agricoles ou de travaux publics</title>
        <meta name="keywords" content="Huile moteur, préconisation, en ligne, quelle huile, meilleure, convient, correcte, camion, utilitaire, agri, agricole, travaux publics, industriel"/>
        <meta name="description" content="Vous voulez savoir quel type d&rsquo;huile convient à votre voiture, camion, véhicule utilitaire, véhicule agricole ou de travaux publics ? Utilisez notre application en ligne pour une préconisation rapide."/>
        <meta name="date" content="2012-01-01"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Mobil&trade; en France | Outil de préconisation d&rsquo;huiles moteur | Trouvez la bonne huile pour votre voiture, camion, véhicule utilitaire, véhicules agricoles ou de travaux publics"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d82028224");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d82028224','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d82028224", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="https://frselector.eame.mobil.com/quelle-huile-pour-ma-voiture/starte" width="680" height="4000" frameborder="0"></iframe></p> </div>
            <div id="subfeatureCallouts">
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82028224", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82028224", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                </div>
