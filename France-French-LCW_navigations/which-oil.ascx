<%@ Control Language="C#" AutoEventWireup="true" Inherits="xom.crown.nav.DynamicNavigation" %><script xmlns:asp="http://schemas.microsoft.com/ASPNET/20" type="text/javascript">
		...
		document.getElementById('which-oil').setAttribute("class","mnNavOn");
		document.getElementById('which-oil').className = "mnNavOn";
		
		addFallback(-1,document.getElementById('which-oil').href);
		document.getElementById('navTitle').innerHTML = document.getElementById('which-oil').innerHTML;
    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/France-French-LCW/which-oil.aspx">guide de sélection des produits Mobil</asp:HyperLink>
                    </li>
