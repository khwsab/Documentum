...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super 3000 Formula 5W-30</title>
        <meta name="keywords" content="Mobil, Super, motor, oil, everyday, synthetic"/>
        <meta name="description" content="Mobil Super&trade; 3000 Formula 5W-30 is a low ash high performance motor oil designed to help prolong the life and maintain the efficiency of the Exhaust Car Emission Reduction Systems in both diesel and gasoline powered automobiles."/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super 3000 Formula 5W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d82081786");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d82081786','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d82081786', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d82081786', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <h1>Mobil Super 3000 Formula 5W-30</h1>
                        <p xmlns="">Mobil Super&trade; 3000 Formula 5W-30 is a low ash high performance motor oil designed to help prolong the life and maintain the efficiency of the Exhaust Car&nbsp;Emission Reduction Systems in both diesel and gasoline powered automobiles.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d82081786', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">Mobil Super 3000 Formula 5W-30 offers excellent performances at both low and high operating temperatures and long term engine protection. Key features and benefits include:</p>

                                    <ul xmlns="">
    
                                        <li>Helps maintain efficiency of Diesel particulate filters and gasoline catalytic convertors</li>
    
                                        <li>Protects engines from wear and deposit build-up</li>
    
                                        <li>Helps fuel economy through reduced friction</li>
    
                                        <li>Suitable for use in both gasoline and diesel passenger cars and light commercial vehicles</li>

                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil Super 3000 Formula 5W-30 is recommended by ExxonMobil for applications requiring Ford WSS-M2C934-B which includes Jaguar and Land Rover vehicles from January 2009 fitted with the 3.0 Litre V6 Diesel engine, and Mazda Diesel engines fitted with Diesel Particulate Filter (DPF) from 2005</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula 5W-30&nbsp; has the following builder approvals:&nbsp;&nbsp; <br>

                                        </strong>Jaguar Land Rover STJLR.03.5005</p>

                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula 5W-30 meets the requirements of the following builder specifications:&nbsp;&nbsp; <br>

                                        </strong>Ford&nbsp;&nbsp;WSS-M2C934-B<br>
&nbsp;</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil Super 3000 Formula 5W-30</th><th width="" scope="col" height="" class="standard">&nbsp;</th>
                                            </tr>
                                        </thead><tbody><tr>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">cSt @ 100ºC</td><td width="" height="" class="standard">10</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Sulfated Ash, wt%, ASTM D 874</td><td width="" height="" class="standard">0.49</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Phosphorous</td><td width="" height="" class="standard">0.049</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Flash Point, ºC, ASTM D 92</td><td width="" height="" class="standard">190</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Density @15º C kg/l, ASTM D 4052</td><td width="" height="" class="standard">850</td>
                                        </tr>
                                        <tr>
