...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="description" content="Mobil 1&trade; FS x1 5W-50 is an advanced performance synthetic engine oil designed to help provide exceptional cleaning power."/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81edb0c5");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81edb0c5','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81edb0c5', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81edb0c5', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil 1&trade; is the world's leading synthetic motor oil brand delivering our ultimate performance and protection. The Mobil 1 technology keeps your engine running like new. Mobil 1&trade; FS x1 5W-50 is an advanced performance synthetic engine oil designed to help provide exceptional cleaning power.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81edb0c5', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">Mobil 1&trade; FS x1 5W-50 is made with a proprietary blend of high performance synthetic base stocks fortified with a precisely balanced component system providing:</p>

                                    <ul xmlns="">
    
                                        <li>Engine wear protection and lubrication over the full oil drain interval.</li>
    
                                        <li>Excellent protection for your engine by helping to prevent the buildup of harmful deposits&nbsp; &nbsp;&nbsp;</li>
    
                                        <li>Enhanced cleaning technology for cars with higher mileage; 100 000km +</li>
    
                                        <li>Improved protection against variable fuel quality*</li>
    
                                        <li>Protection for your engine during start-up at low temperatures</li>

                                    </ul>

                                    <p xmlns="">* Performance compared in industry standard tests, which use fuels designed to promote sludge formation.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil 1 FS x1 5W-50 is recommended for many types of vehicles with higher mileage; &gt; 100 000 km.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 meets or exceeds the requirements of:</strong>
                                        <br>
API, SN, SM<br>
ACEA A3/B3, A3/B4<br>
&nbsp;</p>
                                    ...
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 has the following builder approvals:</strong>
                                        <br>
...
PORSCHE A40</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard"><strong>Mobil 1 FS x1 5W-50</strong></th><th width="" scope="col" height="" class="standard"><strong>Value</strong></th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">&nbsp;Viscosity @ 40C (ASTM D445)</td><td width="" height="" class="standard">&nbsp;101</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Density @15 ºC, g/ml&nbsp; (ASTM D4052)</td><td width="" height="" class="standard">&nbsp;0.85</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
