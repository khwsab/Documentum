...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="keywords" content="Mobil 1, oil, car, engine oil, ESP x2 0W-20"/>
        <meta name="description" content="Mobil 1&trade; ESP x2 0W-20 is an advanced full synthetic engine oil specifically designed to provide outstanding engine cleanliness, wear protection, strong durability and advanced fuel economy to keep your engine running like new."/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81ef3471");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81ef3471','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81ef3471', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    ...
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../UK-English-LCW/Images/120x150_ESP_x2_0w20.png" alt="ESP x2 0w20" title="ESP x2 0w20" border="0" hspace="0"> </div>
                        ...
                        <p xmlns="">* compared vs Mobil 1 ESP Formula 5W-30.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81ef3471', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">Mobil 1 ESP x2 0W-20 is made with a proprietary blend of leading edge components formulated to be fully compatible with the latest Diesel Particulate Filters (DPF's) and Gasoline Catalytic Converters (CAT's). Mobil 1 ESP x2 0W-20 has been designed to help deliver outstanding performance and protection in conjunction with advanced fuel economy benefits. Key features and potential benefits include:</p>
                                    ...
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            ...
                                            <td width="" height="" class="standard">Active cleaning agents</td><td width="" height="" class="standard">

                                                <p>Helps to prevent the buildup of harmful deposits to enable long and clean engine life**</p>

                                                <p>Provides outstanding engine cleanliness and sludge control</p>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Outstanding thermal and oxidation stability</td><td width="" height="" class="standard">
                                                <br>
            Helps to reduce oil aging allowing extended drain interval protection&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">
                                                <br>
            Enhanced frictional properties</td><td width="" height="" class="standard">Provides up to 4% fuel economy improvement versus Mobil 1 ESP Formula 5W-30***</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Excellent low temperature capabilities</td><td width="" height="" class="standard">Quick cold weather performance to help provide fast protection at start-up</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Outstanding high temperature capabilities</td><td width="" height="" class="standard">Provided outstanding high temperature protection over the entire oil drain interval**</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Wear protection</td><td width="" height="" class="standard">Provides outstanding wear protection over the full oil drain interval**</td>
                                        </tr></tbody></table>

                                    <p xmlns="">**Compared to vehicle manufacturer standard</p>

                                    <p xmlns="">
                                        <span style="font-weight: normal">***Savings would be based on switching from a higher viscosity motor oil, similar to Mobil 1 ESP Formula 5W-30, to a 0W-20 viscosity grade. Actual savings are dependent upon vehicle and engine type, outside temperature and barometric pressure, driving conditions and your current engine oil viscosity.</span>
                                    </p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil 1 ESP x2 0W-20 is recommended for the new high-performance gasoline and diesel engines found in emerging European vehicles that require SAE 0W-20 viscosity grades.</p>

                                    <ul xmlns="">

                                        <li>Mobil 1 ESP x2 0W-20 can only be used in the vehicles for which it is approved. It is not backward compatible with older vehicle engines.</li>

                                    </ul>

                                    <ul xmlns="">

                                        <li>Mobil 1 ESP x2 0W-20 is not recommended for 2-Cycle or aviation engines, unless specifically approved by the manufacturer.</li>

                                    </ul>

                                    <p xmlns="">**** Always consult the owner's manual of the vehicle for the manufacturer's recommended viscosity grade and specifications</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 ESP x2 0W-20 has the following OEM approvals:&nbsp; <br>

                                        </strong>Volkswagen (Gasoline / Diesel) 508 00/509 00<br>
Porsche C20&nbsp;<br>
MB-Approval 229.71<br>
Jaguar Land Rover STJLR.51.5122</p>

                                    <p xmlns="">
                                        <strong>Mobil 1 ESP x2 0W-20 meets or exceeds&nbsp;the requirements of:&nbsp;&nbsp;<br>

                                        </strong>ACEA A1/B1, C5&nbsp;<br>
...
API SL</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity, cSt (ATSM D445)</td><td width="" height="" class="standard">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">@ 100ºC</td><td width="" height="" class="standard">7.8</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity Index</td><td width="" height="" class="standard">178</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Sulphated Ash, wt% (ASTM D874)</td><td width="" height="" class="standard">0.8</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">HTHS Viscosity, mPa&bull;s @ 150 ºC (ASTM D4683)</td><td width="" height="" class="standard">2.6</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Pour Point, ºC (ASTM D97)</td><td width="" height="" class="standard">-51</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Flash Point, ºC (ASTM D92)</td><td width="" height="" class="standard">235</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Density @ 15.6 ºC, g/ml (ASTM D4052)</td><td width="" height="" class="standard">0.843</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
