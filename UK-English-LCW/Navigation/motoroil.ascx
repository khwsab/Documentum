<%@ Control Language="C#" AutoEventWireup="true" Inherits="xom.crown.nav.DynamicNavigation" %><script xmlns:asp="http://schemas.microsoft.com/ASPNET/20" type="text/javascript">
		...
		document.getElementById('motoroil').setAttribute("class","mnNavOn");
		document.getElementById('motoroil').className = "mnNavOn";
		
		addFallback(-1,document.getElementById('motoroil').href);
		document.getElementById('navTitle').innerHTML = document.getElementById('motoroil').innerHTML;
