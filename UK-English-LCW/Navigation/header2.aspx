...
<div id="globalHeader" class="clrfix">
    <script type="text/javascript">quickEditForm("0915881d81e20284", "/Content/Logo",false,"../forms/LCWHeaderLogo","","625px","500px","Header Logo","","pencil.gif","");</script><a onclick="trackClick(this);" href="/UK-English-LCW/default.aspx"><img title="" src="/Shared-Images-LCW/headerlogo_86x30_mobil-logo_gbl.jpg" longdesc="" id="logo" border="0" alt="Mobil logo 1"></a>
    <div id="globalCountry">
        <ul>
            ...
            <li style="border: medium none ;">
                <a onclick="trackClick(this);" href="http://www.mobil.com/glp/Default.aspx?page=flags" class="iconleft world">Country Sites</a>
            </li>
        </ul>
    </div>
    ...
    <div id="globalNav">
        <ul class="clrfix">
            ...
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("/UK-English-LCW/contactus_contact.aspx?CountryCode=UK") %> href="/UK-English-LCW/contactus_contact.aspx?CountryCode=UK">contact&nbsp;us</a></li>
        </ul>
    </div>
</div>
<div style="z-index:450;">
    <script type="text/javascript">quickEditForm("0915881d81e20284", "/Content/Top_Navigation",true,"../forms/LCWHeaderTopNav","","680px","700px","Top Navigation","","pencil.gif","");</script>
</div>
<div id="mainNav" class="clrfix">
    <div id="BlueNavPanel_Current_2">
        ...
        <div class="navBarLeft">
            <ul>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/carengineoils.aspx" id="carengineoils">car engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/vanengineoils.aspx" id="vanengineoils">van engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/heavydutyoils.aspx" id="heavydutyoils">heavy duty engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/industrialspecialty.aspx" id="industrialspecialty">industrial &amp; specialty lubricants</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/which-oil.aspx" id="oilselector">which oil</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/buy.aspx" id="wheretobuy">where to buy</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/fuels.aspx" id="fuels">fuels</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/UK-English-LCW/mobilbrands.aspx" id="mobilbrands">Mobil brands</a>
                </li>
            </ul>
        </div>
