<%@ Control Language="C#" AutoEventWireup="true" Inherits="xom.crown.nav.DynamicNavigation" %><script xmlns:asp="http://schemas.microsoft.com/ASPNET/20" type="text/javascript">
		...
		document.getElementById('oilselector').setAttribute("class","mnNavOn");
		document.getElementById('oilselector').className = "mnNavOn";
		
		addFallback(-1,document.getElementById('oilselector').href);
		document.getElementById('navTitle').innerHTML = document.getElementById('oilselector').innerHTML;
    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/UK-English-LCW/which-oil.aspx">which oil</asp:HyperLink>
                    </li>
