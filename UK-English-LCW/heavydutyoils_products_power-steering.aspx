...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="list gn01ne">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d812146f9");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d812146f9','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent">
                    <div class="layoutRow clrfix"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm('0915881d812146f9','/Content',true,'../forms/LCWList','','775px','750px','Page Body','','pencil.gif','');</script><!-- googleon: all -->
                        <h1>Power steering products</h1>
                    </div>
                    <div style="width:99%;position:relative;" class="mc1column">
                        <div class="item clrfix">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../UK-English-LCW/heavydutyoils_products_power-steering_mobi-atf-320.aspx"><img width="90" title="Mobil ATF 320" src="../Shared-Images-LCW/product_90x90_mobil-atf-320_eame.jpg" longdesc="" height="90" border="0" alt="Mobil ATF 320"></a>
                            <h3><a xmlns="" title="" target="_self" onclick="trackClick(this);" href="../UK-English-LCW/heavydutyoils_products_power-steering_mobi-atf-320.aspx">Mobil ATF&trade; 320<span></span></a>
                            </h3>
                            <div class="marginLeft105">&#160;</div>
                        </div>
                        <div class="item clrfix"><a xmlns="" target="_self" onclick="trackClick(this);" href="../UK-English-LCW/heavydutyoils_products_power-steering_mobil-atf-220.aspx"><img width="90" title="Mobil ATF 220" src="../Shared-Images-LCW/product_90x90_mobil-atf-220_eame.jpg" longdesc="" height="90" border="0" alt="Mobil ATF 220"></a>
                            <h3><a xmlns="" title="" target="_self" onclick="trackClick(this);" href="../UK-English-LCW/heavydutyoils_products_power-steering_mobil-atf-220.aspx">Mobil ATF&trade; 220<span></span></a>
                            </h3>
                            <div class="marginLeft105">&#160;</div>
                        </div>
                    </div>
