...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="WT.ti" content="partner and customer login"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d812147f0");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d812147f0','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','-30px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d812147f0", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <img xmlns="" src="../Shared-Images-LCW/article_150x150_handshake_gbl.jpg" height="150" width="150" alt="Handshake" title="Handshake" align="left" border="0" hspace="0" class="imgFloatLeft"><h1 xmlns="">Partner and customer login</h1>
...
Click here to access <a title="" target="" onclick="trackClick(this);" href="http://portal.exxonmobil.com/" class="">DNet</a>.</p>
                        ...
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d812147f0", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --><div xmlns="" class="headerbar">
                                <h3>
                                    <a title="" target="_self" onclick="trackClick(this);" href="../UK-English-LCW/login_business-performance-programme.aspx">Mobil 1&trade; Business Performance Programme<span></span></a>
                                </h3>
                            </div>
                            <div xmlns="" class="padding">
                                <div class="img60 left"><a href="../UK-English-LCW/login_business-performance-programme.aspx" title="Mobil 1&trade; Business Performance Programme" target="_self" onclick="trackClick(this);"><img title="BPP logo" src="../UK-English-LCW/Images/teaser_90x90_mobil-1-business-performance-programme.png" longdesc="" class="floatimgleft" border="0" alt="BPP logo"></a></div>
                                <p>The Mobil 1 Business Performance Programme is designed to provide Car Dealers with a significant opportunity for volume and margin growth.</p>
                            </div>
                        </div>
                    </div>
                    <div class="layoutRow clrfix">
                        ...
                        <div class="subfeature csingle cright">
                            <div xmlns="" class="headerbar">
                                <h3>
                                    <a title="This link will open a new window." target="_blank" onclick="trackClick(this);" href="http://www.signumoilanalysis.com">Signum oil analysis<span></span></a>
                                </h3>
                            </div>
                            <div xmlns="" class="padding">
