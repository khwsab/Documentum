...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="description" content="Mobil 1&trade; is the world&rsquo;s leading synthetic motor oil brand delivering our ultimate performance and protection."/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8207d863");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8207d863','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8207d863', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8207d863', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <h1><strong xmlns="">Mobil 1 FS 0W-40</strong>
                        </h1>Mobil 1&trade; is the world&rsquo;s leading synthetic motor oil brand delivering our ultimate performance and protection.
<p xmlns="" style="text-align: justify; margin: 0in 0in 10pt">Mobil 1&trade; FS 0W-40 European Car Formula (North America) or Protection Formula (rest of the World) Advanced Full Synthetic Motor Oil is engineered for the latest gasoline and diesel (without Diesel Particulate Filters or DPFs) engine technology delivering excellent all-round performance. It provides exceptional cleaning power, wear protection and overall performance. Mobil 1 FS 0W-40 keeps your engine running like new in all driving conditions.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8207d863', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">Mobil 1 FS 0W-40 is made with a proprietary blend of ultra high performance synthetic basestocks fortified with a precisely balanced component system.<ul xmlns="">
                                        <li>Meets or exceeds the latest OEM and industry approvals</li>
                                        <li>Provides excellent overall performance</li>
                                        <li>Has excellent low temperature capabilities for rapid engine protection at start-up</li>
                                        <li>Has enhanced frictional properties that aids fuel economy</li>
                                        <li>Delivers fast protection for reduced engine wear and deposits even in the most extreme driving conditions</li>
                                        <li>Provides exceptional cleaning power for dirty engines.</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">Thanks to extensive cooperative development work with major manufacturers and the application of the latest lubrication technology, Mobil 1 FS 0W-40 is recommended for many types of modern vehicles where it will help provide unsurpassed performance even under very demanding driving conditions.
<ul xmlns="">
    
                                        <li>Latest engine technologies including Turbo-chargers, Direct Injection, Diesels (without DPF) and Hybrids</li>
    
                                        <li>High performance engines</li>
    
                                        <li>Most operating conditions, from mild to extreme</li>

                                    </ul>

                                    <p xmlns="" style="margin: 0in 0in 10pt">Always consult your owner&rsquo;s manual to check recommended viscosity grade and specifications for your particular vehicle.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS 0W-40 meets or exceeds the requirements of:</strong>
                                        <br>
API, SN, SM, SL, SJ<br>
ACEA A3/B3, A3/B4<br>
FIAT 9.55535-M2</p>
                                    ...
                                    <p xmlns="">
                                        <strong>Mobil 1 FS 0W-40 has the following builder approvals:</strong>
                                        <br>
...
VW 503 01</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard"><strong>Mobil 1 FS 0W-40</strong></th><th width="" scope="col" height="" class="standard"><strong>Value</strong></th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">&nbsp;Viscosity, cSt (ASTM D445)</td><td width="" height="" class="standard">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;@ 40º C</td><td width="" height="" class="standard">&nbsp;70.8</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;@ 100º C</td><td width="" height="" class="standard">&nbsp;12.9</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Viscosity Index</td><td width="" height="" class="standard">&nbsp;186</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;MRV at -40ºC, cP (ASTM D4684)</td><td width="" height="" class="standard">&nbsp;21600</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;HTHS Viscosity, mPa&bull;s @ 150ºC, (ASTM D4683)</td><td width="" height="" class="standard">&nbsp;3.6</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Total Base Number (ASTM D2896)</td><td width="" height="" class="standard">&nbsp;12.6</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Sulfated Ash, wt% (ASTM D874)</td><td width="" height="" class="standard">&nbsp;1.34</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Phosphorous, wt% (ASTM D4981)</td><td width="" height="" class="standard">&nbsp;0.1</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Flash Point, ºC (ASTM D92)</td><td width="" height="" class="standard">&nbsp;226</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Density @15ºC, g/ml&nbsp; (ASTM D4052)</td><td width="" height="" class="standard">&nbsp;0.8456</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
