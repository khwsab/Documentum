...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>drivmedelsbesparing som en möjlig kostnadsreduktion</title>
        <meta name="keywords" content="Mobil Delvac, Mobil Delvac 1, Mobil Delvac 1™ LE 5W-30, Mobil Delvac XHP LE 10W-40, bränslebesparingar, drivmedelsbesparing som, kostnadsreduktion, förbrukar mindre energi, lägre, besparingar"/>
        <meta name="description" content="Mobil Delvac 1™ LE 5W-30 motorolja hjälper svenskt transportföretag uppnå bränslebesparingar med i genomsnitt 2,0 %."/>
        <meta name="date" content="2011-10-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil&trade; i Sverige | Heavy-duty motoroljor | Mobil Delvac&trade;-expertkunskaper | RTTR"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d815821d5");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d815821d5','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
					...
					<div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d815821d5", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                    <div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="pop/infographic-widget/index-se-mertz-transport.html" width="690" height="2400" frameborder="0"></iframe></p> </div>
                </div>
