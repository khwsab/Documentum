...
public CookieInformation solutionInfo
   ...
   get
		{
		return EUCookieOptionChecker.getCookieSolutionInfo(Server.MapPath("/Imports/eCookies/"),"cookies.xml","/MOBIL_SB/Sweden-Swedish-LCW");
		}
	set
		{
		solutionInfo = value;
...
<div id="container">
    <div id="globalHeader" class="clrfix">
        <a onclick="trackClick(this);" href="/Sweden-Swedish-LCW/default.aspx"><img title="" src="/Shared-Images-LCW/headerlogo_86x30_mobil-logo_gbl.jpg" longdesc="" id="logo" border="0" alt="Mobil logo 1"></a>
        <div id="globalCountry">
            <ul>
                ...
                <li style="border: medium none ;">
                    <a onclick="trackClick(this);" href="http://www.mobil.com/glp/Default.aspx?page=flags" class="iconleft world">Välj plats</a>
                </li>
            </ul>
        </div>
            ...
            <div id="BlueNavPanel_Current_2">
                ...
                <div class="navBarLeft">
                    <ul>
                        ...
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/vanengineoils.aspx" id="vanengineoils">oljor för lätta transportbilar</a>
                        </li>
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/heavydutyoils.aspx" id="heavydutyoils">heavy-duty motoroljor</a>
                        </li>
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/which-oil.aspx" id="whichoil">Mobil produktväljare</a>
                        </li>
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/industrialspecialty.aspx" id="industrialspecialty">industri- och specialsmörjmedel</a>
                        </li>
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/buy.aspx" id="wheretobuy">var kan jag köpa</a>
                        </li>
                        <li>
                            <a target="" onclick="trackClick(this);" href="/Sweden-Swedish-LCW/mobilbrands.aspx" id="mobilbrands">Mobils varumärken</a>
                        </li>
                    </ul>
                </div>
