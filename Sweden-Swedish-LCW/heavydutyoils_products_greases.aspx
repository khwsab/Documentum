...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; i Sverige | Heavy-duty motoroljor | Mobil fetter</title>
        <meta name="keywords" content="MOBIL CHASSIS GREASE LBZ, MOBILGREASE XHP 222 MINE, ISO VG 220, HALVFLYTANDE FETT, ALLVÄDERSFETT, FETT MED LITIUMKOMPLEX, MOBIL FETT FÖR YRKESFORDON, MOBIL DELVAC"/>
        <meta name="description" content="Mobil&trade; fetter passar centralsmörjsystem och krävande driftsförhållanden&nbsp;"/>
        <meta name="date" content="2011-10-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil&trade; i Sverige | Heavy-duty motoroljor | Mobil fetter"/>
    ...
    <body class="list gn01ne">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81581f30");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81581f30','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent">
                    <div class="layoutRow clrfix"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm('0915881d81581f30','/Content',true,'../forms/LCWList','','775px','750px','Page Body','','pencil.gif','');</script><!-- googleon: all -->
                        <h1>Fetter</h1>
                    </div>
                    <div style="width:99%;position:relative;" class="mc1column">
                        <div class="item clrfix">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/heavydutyoils_products_greases_mobil-grease-xhp-222.aspx"><img width="90" title="Mobilgrease XHP 222" src="../Shared-Images-LCW/product_90x90_mobil-grease-pack_gbl.jpg" longdesc="" height="90" border="0" alt="Mobilgrease XHP 222"></a>
                            <h3><a xmlns="" title="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/heavydutyoils_products_greases_mobil-grease-xhp-222.aspx">Mobilgrease XHP&trade; 222<span></span></a>
                            </h3>
