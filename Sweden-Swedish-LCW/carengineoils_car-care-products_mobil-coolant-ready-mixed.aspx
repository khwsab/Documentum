...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; i Sverige | Bilmotoroljor | Bilvård | Mobil kylarvätska färdigblandad</title>
        <meta name="keywords" content="Mobil kylarvätska färdigblandad"/>
        <meta name="description" content="Mobil&trade; kylarvätska färdigblandad"/>
        <meta name="date" content="2011-10-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil&trade; i Sverige | Bilmotoroljor | Bilvård | Mobil kylarvätska färdigblandad"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81580cc6");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81580cc6','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81580cc6', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-antifreeze-advanced.aspx"><img width="60" title="Mobil Antifreeze Advanced" src="../Shared-Images-LCW/teaser_60x60_mobil-antifreeze-advanced_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Antifreeze Advanced"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-antifreeze-advanced.aspx">Mobil&trade; Antifreeze Advanced</a>
                        </h2>
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-brake-fluid.aspx"><img width="60" title="Mobil Brake Fluid DOT4" src="../Shared-Images-LCW/teaser_60x60_mobil-brake-fluid_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Brake Fluid DOT4"></a> </div>
                        <h2>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81580cc6', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../Shared-Images-LCW/product_120x150_mobil-coolant-ready_eame.jpg" height="150" width="120" alt="Mobil Coolant Ready Mixed -36ºC" title="Mobil Coolant Ready Mixed -36ºC" border="0" hspace="0"> </div>
                        <h1>Mobil&trade; Coolant Ready Mixed -36ºC</h1>
                        <p xmlns="">Mobil&trade; kylarvätska färdigblandad är en kylarvätska med höga prestanda, som ger effektivt skydd ned till -36 °C på vintern.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81580cc6', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fördelar Content">
                                    <p xmlns="">Den är klar att använda.</p>
                                </div>
                            </td>
