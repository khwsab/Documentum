...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="sv" lang="sv">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="description" content="Mobil 1&trade; är världens ledande märke av syntetisk motorolja som levererar det yttersta av prestanda och skyddsförmåga vi kan erbjuda."/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81edaf4c");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81edaf4c','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81edaf4c', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81edaf4c', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil 1&trade; är världens ledande märke av syntetisk motorolja som levererar det yttersta av prestanda och skyddsförmåga vi kan erbjuda. Med Mobil 1 - teknologi kommer din motor alltid att fungera som ny. Mobil 1&trade; FS x1 5W-50 är en högpresterande avancerad helsyntetisk motorolja som framställts för att ge exceptionell rengöringsförmåga.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81edaf4c', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fördelar Content">
                                    <p xmlns="">Mobil 1&trade; FS x1 5W-50 har framställts med en patentskyddad blandning av högpresterande helsyntetiska basoljor som förstärkts med ett noggrant balanserat tillsatssystem för att ge:</p>
                                    <ul xmlns="">
                                        <li>Slitageskydd och smörjning över hela oljebytesintervallet.</li>
                                        <li>Utmärkt skydd för din motor genom att motverka skadliga avlagringar&nbsp;&nbsp;&nbsp;&nbsp;</li>
                                        <li>Förbättrad rengöring för bilar med hög mätarställning över 10.000 mil.</li>
                                        <li>Förbättrat skydd mot skiftande bränslekvaliteter*</li>
                                        <li>Skydd för din motor vid start vid låga temperaturer</li>
                                    </ul>
                                    <p xmlns="">* Prestanda jämförda i industriella standardtest med bränslen som främjar slambildning.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Användningsområden Content">
                                    <p xmlns="">Mobil 1 FS x1 5W-50 rekommenderas för många typer av fordon med höga miltal, över 10.000 mil.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 uppfyller eller överträffar kraven enligt:</strong>
                                        <br>
API, SN, SM<br>
ACEA A3/B3, A3/B4<br>
&nbsp;</p>
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 har följande tillverkares godkännanden:</strong>
                                        <br>
MB godkännande 229.1<br>
MB godkännande 229.3<br>
PORSCHE A40</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Egenskaper Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard"><strong>Mobil 1 FS x1 5W-50</strong></th><th width="" scope="col" height="" class="standard"><strong>Värde</strong></th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">&nbsp;Viskositet vid 40 °C (ASTM D445)</td><td width="" height="" class="standard">&nbsp;101</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Flampunkt, °C (ASTM D 92)</td><td width="" height="" class="standard">&nbsp;239</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Lägsta flyttemperatur, °C (ASTM D 97)</td><td width="" height="" class="standard">&nbsp;-45</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Densitet vid 15 °C, kg/l&nbsp; (ASTM D4052)</td><td width="" height="" class="standard">&nbsp;0,85</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
