...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; i Sverige | Bilmotoroljor | Bilvård | Mobil&trade; Antifreeze Advanced</title>
        ...
        <meta name="WT.ti" content="Mobil&trade; i Sverige | Bilmotoroljor | Bilvård | Mobil&trade; Antifreeze Advanced"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81580c6a");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81580c6a','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81580c6a', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-antifreeze.aspx"><img width="60" title="Mobil Antifreeze" src="../Shared-Images-LCW/teaser_60x60_mobil-antifreeze_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Antifreeze"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-antifreeze.aspx">Mobil&trade; Antifreeze</a>
                        </h2>
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-coolant-ready-mixed.aspx"><img width="60" title="Mobil Coolant Ready Mixed -36ºC" src="../Shared-Images-LCW/teaser_60x60_mobil-coolant-ready-mixed_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Coolant Ready Mixed -36ºC"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-coolant-ready-mixed.aspx">Mobil&trade; Coolant Ready Mixed -36ºC</a>
                        </h2>
                        <div class="relatedContent">&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left"><a xmlns="" target="_self" onclick="trackClick(this);" href="../Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-brake-fluid.aspx"><img width="60" title="Mobil Brake Fluid DOT4" src="../Shared-Images-LCW/teaser_60x60_mobil-brake-fluid_eame.jpg" longdesc="" height="60" border="0" alt="Mobil Brake Fluid DOT4"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Sweden-Swedish-LCW/carengineoils_car-care-products_mobil-brake-fluid.aspx">Mobil&trade; Brake Fluid DOT4</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">&nbsp;&nbsp;</p>&#160;</div>
                    </div>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81580c6a', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil Antifreeze Advanced Concentrate är ett koncentrerat frostskyddsmedel med extra höga prestanda som ska blandas ut före användning.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81580c6a', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fördelar Content">
                                    <p xmlns="">Mobil Antifreeze Advanced innehåller Glysantin® G30® från BASF</p>
                                </div>
                            </td>
