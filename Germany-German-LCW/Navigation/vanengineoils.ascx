    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-city-logistics-p-5w-30.aspx">Mobil Delvac City Logistics P 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_2" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_2" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-city-logistics-f-5w-30.aspx">Mobil Delvac City Logistics F 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_3" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_3" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-city-logistics-v-5w-30.aspx">Mobil Delvac City Logistics V 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_4" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_4" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-city-logistics-m-5w-30.aspx">Mobil Delvac City Logistics M 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_5" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_5" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-city-logistics-r-5w-30.aspx#">Mobil&nbsp;Delvac City Logistics R 5W-30</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_6" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_6" NavigateUrl="/Germany-German-LCW/vanengineoils_mobil-delvac-light-commercial-vehicle-e-10w-40.aspx">Mobil Delvac Light Commercial Vehicle E 10W-40</asp:HyperLink>
                    </li>
            ...
            <asp:panel visible="true" id="L1_7" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_7" NavigateUrl="/Germany-German-LCW/heavydutyengineoils_which-oil.aspx">Mobil Delvac Schmierstoff Wegweiser</asp:HyperLink>
                    </li>
                </ul><% Response.Write((aL1_7.CssClass == "selected") ? "<script type=\"text/javascript\">addFallback(1,\"heavydutyengineoils_which-oil.aspx\")</script>" : ""); %></asp:panel>
            <asp:panel visible="true" id="L1_8" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_8" NavigateUrl="/Germany-German-LCW/vanengineoils_engine.aspx">Motorenöle für Kleintransporter</asp:HyperLink>
                    </li>
