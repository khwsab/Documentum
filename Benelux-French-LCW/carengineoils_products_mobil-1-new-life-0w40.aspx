...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81eca288");</script>
        </div>
...
<%if(current_url_path.IndexOf("wip") <0){%>
         ...
         <%
          ...
          Response.AddHeader("Location","http://www.mobil.be/Benelux-French-LCW/carengineoils_products_mobil-1.aspx");
          %>
...
<%}else{%>    
      ...
      <p style="color:green; font-weight:bold;"><br /><br />Redirect URL is well formed</p> 
          ...
          <p><b><a target="_blank" href="http://www.mobil.be/Benelux-French-LCW/carengineoils_products_mobil-1.aspx">http://www.mobil.be/Benelux-French-LCW/carengineoils_products_mobil-1.aspx</a></b>&#160;&#160;
<script type="text/javascript">quickEdit("0915881d81eca288","/page/RedirectURL","textline","Enter Redirect URL","","pencil.gif","","");</script></p>
