...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <meta name="WT.ti" content="Mobil&trade; en Benelux | Lubrifiants auto | Mobil 1&trade;"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81ef481f");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81ef481f','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ef481f", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ef481f", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d81ef481f", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                        ...
                        <h1>Mobil 1&trade;</h1>
                        <p xmlns="">
                            <a title="" target="" onclick="trackClick(this);" href="/Benelux-French-LCW/carengineoils_products_mobil-1-esp-x2-0w20.aspx" class=""><img src="../Shared-Images-LCW/60x60_ESP_x2_0w20.png" height="60" width="60" alt="Mobil 1 ESP x2 0W-20" title="Mobil 1 ESP x2 0W-20" align="middle" border="0" hspace="0">Mobil 1&trade; ESP x2 0W-20</a>
                        </p>

                        <p xmlns="">
                            <a title="" target="" onclick="trackClick(this);" href="/Benelux-French-LCW/carengineoils_products_mobil-1-fs-0w40.aspx" class=""><img src="../Shared-Images-LCW/teaser_60x60_mobil-1_fs_0w40.png" height="60" width="60" alt="Mobil 1 FS 0W-40" title="Mobil 1 FS 0W-40" align="middle" border="0" hspace="0">Mobil 1&trade; FS 0W-40</a>
                        </p>
