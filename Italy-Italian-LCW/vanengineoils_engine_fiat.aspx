...
<%@ Register Src="Navigation/vanengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d820195d9");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d820195d9','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d820195d9", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d820195d9", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d820195d9", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                            <div id="flashVideoTop"/>
                        </div>
                        <p/>
                        <h1>Oli per furgoni Fiat</h1>
                        <p xmlns="">I veicoli commerciali leggeri Fiat possono trarre vantaggio dall'uso degli oli sintetici Mobil Delvac&trade; ad alte prestazioni, formulati per soddisfare le specifiche Fiat ACEA C2. Per tutti i veicoli commerciali leggeri Fiat è disponibile una gamma completa di oli Mobil Delvac&trade; di cui ci si può fidare. <br>

                            <br>

                            <strong>Oli approvati Fiat ACEA C2 <br>
                            ...
                            <br>
Gli oli completamente sintetici come Mobil Delvac&trade; circolano nei motori Fiat più facilmente degli oli minerali tradizionali, migliorando l'efficienza del motore. Gli effetti di Mobil Delvac&trade; inoltre si manifestano più velocemente, permettendo al motore di raggiunge più rapidamente la massima efficienza operativa. Grazie a questi vantaggi, la vostra flotta di veicoli commerciali leggeri può potenzialmente percorrere più chilometri per ogni litro (km/l), aiutandovi a risparmiare denaro sull'acquisto del diesel e contribuendo a ridurre i costi di manutenzione e di riparazione del motore. <br>

                            <br>

                            <strong>In che modo Mobil Delvac&trade; è utile ai miei motori Fiat? <br>
...
ExxonMobil consiglia <a title="" target="" onclick="trackClick(this);" href="http://lubes.mobil.com/Italy-Italian-LCW/vanengineoils_mobil-delvac-city-logistics-p-5w-30.aspx" class="">Mobil Delvac&trade; City Logistics P 5W-30 </a>per condizioni di guida normali e occasionalmente impegnative, compresa la guida in città. <br>
                            ...
                            <strong>Come posso trovare l'olio più adatto al mio furgone Fiat? </strong>
                            <br>

                            <br>
Per soddisfare i requisiti delle specifiche Fiat è importante utilizzare un olio appropriato nel motore del veicolo commerciale leggero. L'utilizzo del prodotto Mobil Delvac&trade; ottimale durante la manutenzione ordinaria e in conformità al manuale del veicolo non avrà alcun effetto sulla garanzia del produttore fornita da Fiat. Lo strumento "Quale olio usare" consiglia il prodotto ideale eseguendo una ricerca in base alla marca e al modello.</p>
                    </div>
                </div>
