...
<%@ Register Src="Navigation/vanengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d82019510");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d82019510','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82019510", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d82019510", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d82019510", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                            <div id="flashVideoTop"/>
                        </div>
                        <p/>
                        <h1>Oli per furgoni Mercedes-Benz</h1>
                        <p xmlns="">I veicoli commerciali leggeri Mercedes Benz possono trarre vantaggio dall'uso degli oli sintetici Mobil Delvac&trade; ad alte prestazioni, formulati per soddisfare le specifiche MB 229.31, 229.51 e 229.52. Per tutti i veicoli commerciali leggeri Mercedes Benz è disponibile una gamma completa di oli Mobil Delvac&trade; di cui ci si può fidare. <br>

                            <br>

                            <strong>Oli approvati Mercedes Benz 229.31, 229.51 e 229.52</strong> 
                            <br>
                            ...
                            <strong>Oli approvati Mercedes Benz 229.1</strong> 
                            <br>
                            ...
                            <br>
Gli oli completamente sintetici e semi-sintetici come Mobil Delvac&trade; circolano nei motori Mercedes Benz più facilmente degli oli minerali tradizionali, migliorando l'efficienza del motore. Gli effetti di Mobil Delvac&trade; inoltre si manifestano più velocemente, permettendo al motore di raggiunge più rapidamente la massima efficienza operativa. Grazie a questi vantaggi, la vostra flotta di veicoli commerciali leggeri può potenzialmente percorrere più chilometri per ogni litro (km/l), aiutandovi a risparmiare denaro sull'acquisto del diesel e contribuendo a ridurre i costi di manutenzione e riparazione del motore. <br>

                            <br>

                            <strong>In che modo Mobil Delvac&trade; è utile ai miei motori Mercedes Benz? </strong>
                            <br>
...
ExxonMobil consiglia <a title="" target="" onclick="trackClick(this);" href="/Italy-Italian-LCW/vanengineoils_mobil-delvac-city-logistics-m-5w-30.aspx" class="">Mobil Delvac&trade; City Logistics M 5W-30 </a>e <a title="" target="" onclick="trackClick(this);" href="/Italy-Italian-LCW/vanengineoils_mobil-delvac-light-commercial-vehicle-e-10w-40.aspx" class="">Mobil Delvac&trade; Light Commercial Vehicle E 10W-40</a> per condizioni di guida normali e occasionalmente impegnative, compresa la guida in città. <br>
                            ...
                            <strong>Come posso trovare l'olio più adatto al mio furgone Mercedes Benz?</strong> 
                            <br>

                            <br>
Per soddisfare i requisiti delle specifiche Mercedes Benz è importante utilizzare un olio appropriato nel motore del veicolo commerciale leggero. L'impiego del prodotto Mobil Delvac appropriato durante la manutenzione di routine e in conformità con il manuale del veicolo non avrà alcun effetto sulla garanzia del produttore Mercedes Benz. Lo strumento "Quale olio usare" consiglia il prodotto ideale eseguendo una ricerca in base alla marca e al modello.</p>
                    </div>
                </div>
