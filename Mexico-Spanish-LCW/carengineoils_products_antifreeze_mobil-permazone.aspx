...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; México |&nbsp;Anticongelantes&nbsp;| Mobil Permazone&trade;</title>
        <meta name="keywords" content="Mobil, Mobil Permazone, eje, trasero, eje trasero, engranes, engranajes, lubricación, caja, automática, manual, relación"/>
        <meta name="description" content="Mobil Permazone&trade; es un anticongelante convencional de color verde que brinda protección contra el congelamiento, el sobrecalentamiento, el oxido y la corrosión, cuando se utiliza como es recomendado."/>
        <meta name="date" content="2012-11-01"/>
        <meta name="language" content="es"/>
        <meta http-equiv="Content-Language" content="es"/>
        <meta name="WT.ti" content="Mobil&trade; México |&nbsp;Anticongelantes&nbsp;| Mobil Permazone&trade;"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d80f38210");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d80f38210','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d80f38210', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d80f38210', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="../Mexico-Spanish-LCW/Images/product_120x150_Mobil-Permazone.jpg" height="150" width="120" alt="Mobil Permazone" title="Mobil Permazone" border="0" hspace="0"> </div>
                        <h1>Mobil Permazone&trade;</h1>
                        <p xmlns="">Mobil Permazone es un anticongelante convencional de color verde que brinda protección contra el congelamiento, el sobrecalentamiento, el oxido y la corrosión, cuando se utiliza como es recomendado.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d80f38210', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                <div style="z-index:100; " id="divTabs">
                                    <ul>
                                        <li onmouseover="if(this.className!='current')this.className='highlight';" onmouseout="if(this.className!='current')this.className=''" class="current" id="Descripción del producto">
                                            <a href="#" onclick="javascript:showTab('Descripción del producto');">Descripción del producto</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Descripción del producto Content">
                                    <p xmlns="">Mobil Permazone contiene una fórmula universal de bajo contenido de silicatos, esta protege todas las superficies metálicas, incluyendo el aluminio, en todo uso convencional automotriz y camiones de servicio ligero. En la aplicación de servicio pesado, requiere de la adición de aditivos suplementarios de refrigeración (ASR).&nbsp;</p>
                                </div>
                            </td>
