...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super&trade; 1000 | Car Engine Oils &amp; Products | Mobil&trade; Canada</title>
        <meta name="keywords" content="Car Engine Oils, Mobil Super 1000 5W-30,engine oil, motor oil, lubricant"/>
        <meta name="description" content="Mobil Super&trade; 1000 oils give your engine the protection it requires and the performance you expect from your vehicle under a wide variety of operating conditions."/>
        <meta name="date" content="2010-01-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super&trade; 1000 | Car Engine Oils &amp; Products | Mobil&trade; Canada"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81b39a68");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81b39a68','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81b39a68', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Canada-English-LCW/carengineoils_products_mobil-super_2000-5w30.aspx"><img width="60" title="Mobil Super 2000" src="../Canada-English-LCW/Images/teaser_60x60_mobil-super-2000.jpg" longdesc="" height="60" border="0" alt="Mobil Super 2000"></a> </div>
                        <h2>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81b39a68', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">
                            <strong>Premium Automotive Motor Oil<br>

                            </strong>
                        </p>

                        <p xmlns="">Mobil Super&trade; 1000 oils are formulated from quality base stocks combined with modern performance additives to give your engine the protection it requires and the performance you expect from your vehicle under a wide variety of operating conditions.</p>

                        <p xmlns="">Mobil Super 1000 oils are available in three multi-viscosity grades: SAE 5W-20, 5W-30 and 10W-30.</p>

                        <p xmlns="">Mobil Super 1000 5W-20, 5W-30 and 10W-30 meet the warranty requirements where an American Petroleum Institute (API) certified oil is specified. All three products meet or exceed ILSAC GF-5 and API SN and are backward compatible with earlier performance levels such as API SM, SL, and SJ. The American Petroleum Institute (API) classifies these three products as "Resource Conserving" engine lubricants.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81b39a68', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
