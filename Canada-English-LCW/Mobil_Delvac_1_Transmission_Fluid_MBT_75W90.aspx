...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8207b3b6");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8207b3b6','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8207b3b6', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8207b3b6', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash">
                            <img xmlns="" src="http://lubes.mobil.com/Canada-English-LCW/Images/Delvac_1_Transmission_Fluid_MBT_75W-90.jpg" height="150" width="120"> </div>
                        <h1>Mobil Delvac&trade; 1 Transmission Fluid MBT 75W-90</h1>
                        <p xmlns="">Mobil Delvac&trade; 1 Transmission Fluid MBT is an SAE 75W-90, fully synthetic manual transmission oil.&nbsp; Mobil Delvac 1 Transmission Fluid MBT 75W-90 has excellent viscosity/temperature characteristics.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8207b3b6', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                <div style="z-index:100; " id="divTabs">
                                    <ul>
                                        ...
                                        <li onmouseover="if(this.className!='current')this.className='highlight'" onmouseout="if(this.className!='current')this.className=''" id="Typical Properties">
                                            <a href="#" onclick="javascript:showTab('Typical Properties');">Typical Properties</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT is formulated with an advanced additive system providing excellent thermal stability and wear resistance. Mobil Delvac 1 Transmission Fluid MBT maintains lower temperatures in the transmission compared to conventional transmission oils. It is recommended for most manual transmissions, transaxles and mild hypoid axles where an API GL-5 oil is not required. Mobil Delvac 1 Transmission Fluid MBT is suited for use in transmissions (gearboxes) where lubricants are exposed to very high temperatures under full-load service.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT is approved against the Mercedes-Benz specification sheet MB 235.11 covering Actros manual transmissions, including those with transfer cases.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specifications Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT has the following builder approvals:</p>

                                    <p xmlns="">
                                        <br>
MB-Approval 235.11</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Typical Properties Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT<br>
                                        <br>
SAE Grade: SAE 75W-90<br>
Viscosity, ASTM D 445&nbsp;&nbsp; <br>
cSt @ 40ºC: 96.3<br>
cSt @ 100ºC: 14.7<br>
Brookfield Viscosity at -40 ºC cP max: 59000<br>
Pour Point, ºC, ASTM D 97:&nbsp;-45<br>
Flash Point, ºC, ASTM D 92, min: 179<br>
Viscosity Index, ASTM D 2270: 159</p>
                                </div>
                            </td>
