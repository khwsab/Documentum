...
<div id="globalHeader" class="clrfix">
    ...
    <div id="globalNav">
        <ul class="clrfix">
            ...
            <li><a onclick="trackClick(this);" target="" <% =isCurrent("http://www.imperialoil.ca/Canada-English/contactus.aspx") %> href="http://www.imperialoil.ca/Canada-English/contactus.aspx">contact us</a></li>
        </ul>
    </div>
</div>
