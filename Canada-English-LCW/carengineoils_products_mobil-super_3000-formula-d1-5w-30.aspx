...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super&trade; 3000 Formula D1 5W-30 | Car Engine Oils &amp; Products | Mobil&trade; Canada</title>
        ...
        <meta name="WT.ti" content="Mobil Super&trade; 3000 Formula D1 5W-30 | Car Engine Oils &amp; Products | Mobil&trade; Canada"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81d31979");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81d31979','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81d31979', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        ...
                        <div class="relatedContent">
                            <p xmlns="">Mobil Super&trade; 3000 Formula D1 5W-30 meets and exceeds dexos1 specifications. <br>
Mobil Super&trade; 3000 Formula D1 5W-30 is approved for GM dexos1</p>&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left">
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81d31979', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash"> </div>
                        <h1>Mobil Super&trade; 3000 Formula D1 5W-30</h1>
                        <p xmlns="" align="left">
                            <a title="" target="" onclick="trackClick(this);" href="/Canada-English-LCW/Images/640x800_ms3000_d1_5w-30_1l.png" class="lightview"><img src="../Canada-English-LCW/Images/120x150_ms3000_d1_5w-30_1l.png" height="150" width="120" alt="Mobil Super 3000 Formula D1 5-30" title="Mobil Super 3000 Formula D1 5-30" align="left" border="15" hspace="5"></a>
                        </p>

                        <p xmlns="">
                            <strong>Synthetic Motor Oil</strong>
                        </p>

                        <p xmlns="">Mobil Super&trade; 3000 Formula D1 5W30 is a synthetic motor oil, which provides excellent high temperature protection even under severe operating conditions. Mobil Super 3000 is designed to help provide long engine life and outstanding protection in vehicles of all ages. Mobil Super 3000 provides outstanding protection against sludge, engine rust and corrosion under severe and low-temperature operating conditions and provides optimum viscosity and fluidity across a broad range of temperatures.</p>

                        <p xmlns="">Mobil Super 3000 Formula D1 5W30, is classified by The American Petroleum Institute (API) as a "Resource Conserving" engine lubricant and meets or exceeds ILSAC GF-5 and API service SN. Those claims are backward compatible with earlier performance levels such as API SM, SL, and SJ and previous ILSAC categories.</p>

                        <p xmlns="">Mobil Super 3000 Formula D1 5W30 is approved against General Motors dexos1® under the license D10032GC015.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81d31979', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil Super 3000 Formula D1 5W30 is recommended for gasoline fueled automobiles where a 5W-30 viscosity is required. It meets or exceeds the requirements of API SN, SM and ILSAC GF-5 (Starburst Certification Symbol)</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula D1 5W-30 meets or exceeds the requirements of:&nbsp;&nbsp; <br>
...
ILSAC GF-5</p>
                                    ...
                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula D1 5W-30 has the following builder approvals:&nbsp;&nbsp; <br>

                                        </strong>Dexos1® under license D10032GC015</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil Super 3000 Formula D1</th><th width="" scope="col" height="" class="standard">5W-30</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">Specific Gravity</td><td width="" height="" class="standard">0.8364</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Pour Point, °C</td><td width="" height="" class="standard">-42</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Flash Point, °C, ASTM D 92</td><td width="" height="" class="standard">239</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity</td><td width="" height="" class="standard">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cSt at 40°C</td><td width="" height="" class="standard">66.4</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cSt at 100°C</td><td width="" height="" class="standard">11.7</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">CCS, cP</td><td width="" height="" class="standard">6350@ -35°C</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">MRV, cP</td><td width="" height="" class="standard">11500@ -35°C</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity Index</td><td width="" height="" class="standard">174</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Resource Conserving</td><td width="" height="" class="standard">Yes</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
