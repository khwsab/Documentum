...
<%@ Register Src="Navigation/fuels.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; Canada | Car Engine Oils | Products | Mobil Super&trade; 3000 Formula D1 5W-30</title>
        <meta name="keywords" content="Car Engine Oils, Mobil Super 3000 Formula D1 5W-30, engine oil, motor oil, lubricant"/>
        <meta name="description" content="Find out more about Mobil Super&trade; 3000 Formula D1 5W-30"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil&trade; Canada | Car Engine Oils | Products | Mobil Super&trade; 3000 Formula D1 5W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d814c3d2c");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d814c3d2c','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d814c3d2c', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d814c3d2c', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil Super 3000 Formula D1 5W30 is approved against General Motors dexos1® under the license GB1D1010015.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d814c3d2c', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil Super 3000 3000 Formula D1 5W30 is recommended for gasoline fueled automobiles where a 5W-30 viscosity is required. It meets or exceeds the requirements of API SN, SM and ILSAC GF-5 (Starburst Certification Symbol)</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil Super 3000 Formula D1 5w-30 meets or exceeds the requirements of:&nbsp;&nbsp;</strong> 
                                        <br>
API SN <br>
API SM <br>
ILSAC GF-5</p>
                                    ...
                                    <p xmlns="">
                                        ...
                                        </strong>Dexos1® under license GB1C0124015</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            ...
                                            <td width="" height="" class="standard">Specific Gravity</td><td width="" height="" class="standard">0.8378</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Pour Point, °C</td><td width="" height="" class="standard">-51</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">cSt at 40°C</td><td width="" height="" class="standard">65.1</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cSt at 100°C</td><td width="" height="" class="standard">11.2</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">CCS, cP</td><td width="" height="" class="standard">4850@ -30°C</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">MRV, cP</td><td width="" height="" class="standard">13900@ -35°C</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity Index</td><td width="" height="" class="standard">167</td>
                                        </tr>
                                        <tr>
