...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil 1&trade;&nbsp;HM 5W-30&nbsp;| Car Engine Oils &amp; Products | Mobil&trade; Canada</title>
        <meta name="keywords" content="Car Engine Oils, Mobil 1&nbsp;HM 5W-30, engine oil, motor oil, lubricant"/>
        <meta name="description" content="Mobil 1&trade; High Mileage 5W-30 features an extra performance additive that helps to provide outstanding protection during today's longer oil change intervals."/>
        <meta name="date" content="2010-01-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil 1&trade;&nbsp;HM 5W-30&nbsp;| Car Engine Oils &amp; Products | Mobil&trade; Canada"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81d1011f");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81d1011f','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81d1011f', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
...
Mobil 1 Extended Performance 5W-30 is approved for GM dexos1</p>&#160;</div>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81d1011f', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        <div style="float:left" id="flash"> </div>
                        <h1>Mobil 1&trade; High Mileage 5W-30</h1>
                        <p xmlns="" align="left">
                            <a title="" target="" onclick="trackClick(this);" href="/Canada-French-LCW/Images/product_120x150_mobil-1-hm-5w30-4l.png" class="lightview"><img src="../Canada-French-LCW/Images/product_120x150_mobil-1-hm-5w30-4l.png" height="150" width="120" alt="Mobil 1 High Mileage 5W-30" title="Mobil 1 High Mileage 5W-30" align="left" border="15" hspace="5"></a>
                        </p>

                        <p xmlns="">Mobil 1&trade; High Mileage 5W-30 is designed to help maximize engine performance and extend the engine life of vehicles with over 120,000 kilometers.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81d1011f', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
...
Note 1 -- If your engine has excessive sludge deposits due to less-than-adequate maintenance practices, Mobil 1 High Mileage 5W-30 can help by reducing the sludge left behind in your engine. For severe cases of sludge, short oil change intervals (5000 - 8000 kilometers) are recommended for the first 2-3 oil changes as reduction of the sludge takes place. In cases of engine damage that may have resulted from poor maintenance, even Mobil 1 cannot remedy years of neglect.</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">Mobil 1 High Mileage 5W-30 is recommended for vehicles with over 120,000 kilometers including passenger cars, SUVs, light vans and trucks.</p>

                                    <ul xmlns="">
    
                                        <li>Mobil 1 High Mileage 5W-30 is suitable for many types of severe driving applications including high speed highway and stop and go city driving.&nbsp;</li>
    
                                        <li>Mobil 1 High Mileage 5W-30&nbsp;is not recommended for 2-Cycle or aviation engines, unless specifically approved by the manufacturer. <br>
    &nbsp;</li>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>
                                            ...
                                            <table width="100%" summary="" class="standard" cellspacing="0" border="0">
                                                <thead>
                                                    <tr>
                                                        <th width="" scope="col" height="" class="standard">Mobil 1 High Mileage 5W-30 meets or exceeds the requirements of:&nbsp;</th><th width="" scope="col" height="" class="standard">&nbsp;</th>
                                                    </tr>
                                                </thead><tbody><tr>
                                    ...
                                    <p xmlns="">
                                        <strong>According to ExxonMobil, Mobil 1 High Mileage 5W-30 is of the following quality level: </strong>
                                        <br>
API CF</p>
                                </div>
                                    ...
                                    <p xmlns="">
                                        ...
                                        <table width="100%" summary="" class="standard" cellspacing="0" border="0">
                                            <thead>
                                                ...
                                                <td width="" height="" class="standard">SAE Grade</td><td width="" height="" class="standard">&nbsp;</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="" height="" class="standard">Viscosity Index</td><td width="" height="" class="standard">165</td>
                                            </tr>
                                            <tr>
