...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>our normal</title>
        <meta name="keywords" content="our normal"/>
        <meta name="description" content="our normal"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="our normal"/>
    ...
    <body class="landing">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81ca045b");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81ca045b','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d81ca045b", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <div id="flashFeature">
                            <img width="442" title="Feature Image" src="../Shared-Images-LCW/media_442x280_our_normal_en.gif" height="280" border="0" alt="Feature Image"/>
                        </div>
                      <script type="text/javascript">
                        var so = new SWFObject("/Shared-Flash-LCW/media_442x280_our_normal_en.swf", "xomlandingflash", "442", "280", "8");
                      ...
                      <h1>What is our normal?</h1>
                        <div xmlns="" id="" class="img495">
                            <script type="text/javascript" language="JavaScript">
						var so = new SWFObject("//Shared-Flash-LCW/media_442x280_our_normal_en.swf",	//Flash movie name
						...
						dcsMultiTrack('dcssip',document.domain,'dcsuri','/Shared-Flash-LCW/media_442x280_our_normal_en.swf','WT.ti','/Shared-Flash-LCW/media_442x280_our_normal_en.swf','DCSext.container',window.location.pathname,'WT.cg_n','Flash');
					</script>
                        </div>
                        <p xmlns="">After undergoing rigorous tests in our own labs and by independent industry experts, Mobil 1&trade; synthetic motor oil is proven to provide outstanding performance and protection for your engine. Testing under conditions both real and extreme for proven performance in harsh conditions &ndash; that&rsquo;s our normal.</p> </div>
...
Product Data Sheet<span></span></a>
                                    ...
                                    <p xmlns="">View a complete PDS listing<br>
for Canada</p>
                                </div>
                            </div>
                        </div>
...
Mobil 1 Lube Express</p>
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ca045b", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d81ca045b", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                </div>
