...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Super&trade; ATF 3309 | Automatic Transmission Fluid | Mobil&trade; Canada</title>
        <meta name="keywords" content="Mobil Super ATF 3309, transmission, fluid, ATF, AFT"/>
        <meta name="description" content="Mobil Super&trade; ATF 3309 is an exceptionally high performance lubricant for use in certain slip-controlled lock-up automatic transmissions."/>
        <meta name="date" content="2010-01-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Super&trade; ATF 3309 | Automatic Transmission Fluid | Mobil&trade; Canada"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81714e70");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81714e70','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81714e70', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Canada-English-LCW/automatic-transmission-fluid_mobil-1-synthetic-atf.aspx"><img width="60" title="Mobil 1 Synthetic" src="../Canada-English-LCW/Images/teaser_60x60_mobil-1-synthetic-atf.jpg" longdesc="" height="60" border="0" alt="Mobil 1 Synthetic"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Canada-English-LCW/automatic-transmission-fluid_mobil-1-synthetic-atf.aspx">Mobil 1&trade; Synthetic ATF</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">&nbsp;&nbsp;</p>&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Canada-English-LCW/automatic-transmission-fluid_mobil-super-atf-plus4.aspx"><img width="60" title="Mobil Super ATF 4" src="../Canada-English-LCW/Images/teaser_60x60_mobil-atf-4.jpg" longdesc="" height="60" border="0" alt="Mobil Super ATF 4"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Canada-English-LCW/automatic-transmission-fluid_mobil-super-atf-plus4.aspx">Mobil Super&trade; ATF +4</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">&nbsp;&nbsp;</p>&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Canada-English-LCW/automatic-transmission-fluid_mobil-super-atf-dm.aspx"><img width="60" title="Mobil Super ATF DM" src="../Canada-English-LCW/Images/teaser_60x60_mobil-super-atf-dm.jpg" longdesc="" height="60" border="0" alt="Mobil Super ATF DM"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Canada-English-LCW/automatic-transmission-fluid_mobil-super-atf-dm.aspx">Mobil Super&trade; ATF D/M</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">&nbsp;&nbsp;</p>&#160;</div>
                    </div>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81714e70', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81714e70', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <p xmlns="">The unique formulation of Mobil ATF 3309 is designed to provide excellent lubrication of transmissions in specified slip-controlled lock-up automatic transmissions. These outstanding performance capabilities translate into significant operational benefits, including:</p>
                                    <ul xmlns="">
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="App Content">
                                    <p xmlns="">Mobil ATF 3309 is recommended for use in transmissions requiring fluids of JWS 3309 or GM 9986195 quality levels. It is also recommended for service fill applications where Toyota T-IV is requried. Please refer to the owners&rsquo; manual for proper fluid requirements.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">Mobil ATF 3309 meets or exceeds the requirements of: <br>
Ford WSS-M2C924-A <br>
VW TL 52540-A</p>

                                    <p xmlns="">&nbsp;<br>
According to Imperial Oil, Mobil ATF 3309 is of the following quality level: <br>
Audi G-055-025-A2 <br>
Saturn GM9986195 <br>
Toyota Type T-IV <br>
VW G-055-025-A2</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil ATF 3309</th><th width="" scope="col" height="" class="standard">Value</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">cSt @ 100ºC</td><td width="" height="" class="standard">7.1</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cSt @ 40ºC</td><td width="" height="" class="standard">33</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">cP @ -40ºC</td><td width="" height="" class="standard">13,000</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscosity Index</td><td width="" height="" class="standard">181</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Flash Point, ºC &rsaquo;</td><td width="" height="" class="standard">198</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Density&nbsp;</td><td width="" height="" class="standard">0.852</td>
                                        </tr>
                                        <tr>
