...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil 1&trade; ESP Formula 5W-30 | Car Engine Oils &amp; Products | Mobil&trade; Canada</title>
        <meta name="keywords" content="Car Engine Oils, ESP Formula 5W-30, engine oil, motor oil, lubricant"/>
        <meta name="description" content="Mobil 1&trade; ESP Formula 5W-30 is an advanced performance synthetic engine oil designed to help provide exceptional cleaning power, wear protection and overall performance."/>
        <meta name="date" content="2016-01-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil 1&trade; ESP Formula 5W-30 | Car Engine Oils &amp; Products | Mobil&trade; Canada"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81d8db03");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81d8db03','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81d8db03', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81d8db03', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                ...
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Overview Content">
                                    ...
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            ...
                                            <td width="" height="" class="standard">Low Ash Content</td><td width="" height="" class="standard">Helps to reduce particulate build up in Diesel Particulate Filters <br>
            &nbsp;</td>
                                        </tr>
                                        <tr>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        ...
                                        Peugeot/Citro�n Automobiles B71 2290&nbsp;/ B71 2297<br>
                                        GM Dexos</p>
                                    ...
                                    <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech Details Content">
                                        <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td width="" height="" class="standard">@ 40�C</td><td width="" height="" class="standard">72.8</td>
                                            </tr>
                                            <tr>
                                                <td width="" height="" class="standard">@ 100�C</td><td width="" height="" class="standard">12.1</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="" height="" class="standard">HTHS Viscosity, mPa&bull;s @ 150 �C (ASTM D4683)</td><td width="" height="" class="standard">3.58</td>
                                            </tr>
                                            <tr>
                                                <td width="" height="" class="standard">Pour Point, �C (ASTM D97)</td><td width="" height="" class="standard">-45</td>
                                            </tr>
                                            <tr>
                                                <td width="" height="" class="standard">Flash Point, �C (ASTM D92)</td><td width="" height="" class="standard">254</td>
                                            </tr>
                                            <tr>
                                                <td width="" height="" class="standard">Density @ 15.6 �C, g/ml (ASTM D4052)</td><td width="" height="" class="standard">0.850</td>
                                            </tr></tbody></table>
                                    </div>
                                </td>
