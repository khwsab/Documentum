...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; Suomessa | Raskaan kaluston moottoriöljyt | Manuaali- ja automaattivaihteisto</title>
        <meta name="keywords" content="MOBILUBE XHP 75W-80, VOITELUAINE, MOOTTORIN VOITELUAINEET, AUTON VOITELUAINE, SYNTEETTINEN YHDISTELMÄ KÄSIVAIHTEISTOÖLJY, RASKAAN KALUSTON VAIHTEISTOÖLJY"/>
        ...
        <meta name="WT.ti" content="Mobil&trade; Suomessa | Raskaan kaluston moottoriöljyt | Manuaali- ja automaattivaihteisto"/>
    ...
    <body class="list gn01ne">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81fc4267");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81fc4267','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent">
                    <div class="layoutRow clrfix"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm('0915881d81fc4267','/Content',true,'../forms/LCWList','','775px','750px','Page Body','','pencil.gif','');</script><!-- googleon: all -->
                        <h1>Manuaali - ja automaattivaihteisto</h1>
                    </div>
                    <div style="width:99%;position:relative;" class="mc1column">
                        <div class="item clrfix">
                            ...
                            <h3><a xmlns="" title="" target="_self" onclick="trackClick(this);" href="../Finland-Finnish-LCW/heavydutyoils_products_rear-axle_mobilube-1-shc-75w90.aspx">Mobilube 1 SHC&trade; 75W-90<span></span></a>
                            </h3>
