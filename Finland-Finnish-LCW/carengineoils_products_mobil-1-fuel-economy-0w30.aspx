...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fi" lang="fi">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; Suomessa | Henkilöautojen moottoriöljyt | Mobil 1&trade; Fuel Economy 0W-30</title>
        <meta name="keywords" content="Mobil 1 Fuel Economy 0W-30, moottoriöljy, voiteluaine, mobil 1 esp, mobile, moottorin voiteluaineet, liikkuva, synteettinen, synteettiset, voiteluöljyt, voitelu, öljyt, voitelurasva, rasva, mobil, exxonmobil, exxon, Mobil1, Mobil 1, BP, Shell, moottoriurheilu, F1, Formula 1, Lewis Hamilton, McLaren, castrol"/>
        <meta name="description" content="Lue lisää Mobil 1&trade; Fuel Economy 0W-30 -moottoriöljystä"/>
        <meta name="date" content="2011-06-01"/>
        <meta name="language" content="fi"/>
        <meta http-equiv="Content-Language" content="fi"/>
        <meta name="WT.ti" content="Mobil&trade; Suomessa | Henkilöautojen moottoriöljyt | Mobil 1&trade; Fuel Economy 0W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8207cef7");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8207cef7','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8207cef7', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Finland-Finnish-LCW/carengineoils_products_mobil-1-esp-formula-5w30.aspx"><img width="60" title="ESP Formula 5W-30" src="../Shared-Images-LCW/teaser_60x60_mobil-1-esp-5w30_eame.jpg" longdesc="" height="60" border="0" alt="ESP Formula 5W-30"></a> </div>
                        <h2>
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d8207cef7', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">
                            <strong>Edistyksellinen täyssynteettinen moottoriöljy<br>

                            </strong>Mobil 1&trade; on maailman johtava synteettisten moottoriöljyjen tuotemerkki, jonka tuotteet antavat moottorille äärimmäisen suorituskyvyn ja suojan.</p>

                        <p xmlns="">Mobil 1 Fuel Economy 0W-30 on testattu ja luotettu tuotteemme, joka antaa ensiluokkaisen moottorisuojan ja joka parantaa polttoainetaloutta.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8207cef7', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Edut Content">
                                    <p xmlns="">Mobil 1 Fuel Economy 0W-30 valmistetaan äärimmäisen suorituskykyisten täyssynteettisten perusöljyjen patentoidusta yhdistelmästä, jota on parannettu tarkasti tasapainotetulla lisäainejärjestelmällä. Öljy on valmistettu tarjoamaan ylittämätöntä suorituskykyä, puhdistustehoa ja moottorin suojausta erityisesti käynnistyksissä kaikkein kylmimmissä olosuhteissa. Tärkeimmät edut ja ominaisuudet:</p>
                                    <ul xmlns="">
                                        <li>Parannetut kitkaominaisuudet parantavat polttoainetaloutta</li>
                                        <li>Ensiluokkainen moottorin puhtaus ja olemassa olevan sakan poisto.</li>
                                        <li>Erinomainen suorituskyky matalissa lämpötiloiissa nopeuttaa käynnistystä kylmällä säällä ja antaa nopeasti kulumissuojan moottorille.</li>
                                        <li>Erittäin suorituskykyiset perusöljyt antavat erinomaisen kulumissuojan kaikissa tilanteissa.</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Käyttökohteet Content">
                                    <p xmlns="">Mobil 1 Fuel Economy 0W-30 -öljyä suositellaan monentyyppisille nykyaikaisille ajoneuvoille, mukaan lukien tehokkaat turboahdetut bensiinimoottorit ja dieselmoottori (ilman hiukkassuodatinta).</p>
                                    <ul xmlns="">
                                        <li>Mobil 1 Fuel Economy 0W-30 -öljy on suunniteltu tarjoamaan ensiluokkaista suojaa moottorille ja edistämään polttoainetaloudellisuutta.</li>
                                        <li>Mobil 1 Fuel Economy 0W-30 -öljyä suositellaan äärimmäisen kylmiin olosuhteisiin, joissa se auttaa nopeuttamaan käynnistystä ja voitelua.</li>
                                    </ul>
                                    <p xmlns="">Tarkista aina omistajan käsikirjasta ajoneuvosi suositeltu viskositeettiluokka ja spesifikaatiot.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Luokitukset Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 Fuel Economy 0W-30 täyttää tai ylittää seuraavien spesifikaatioiden vaatimukset:&nbsp;&nbsp; <br>

                                        </strong>ACEA A1/B1, A5/B5</p>

                                    <p xmlns="">
                                        <strong>ExxonMobilin mukaan Mobil 1 Fuel Economy 0W-30 on seuraavaa laatutasoa:&nbsp;&nbsp;<br>
...
API CF</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Ominaisuudet Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil 1 Fuel Economy 0W-30</th><th width="" scope="col" height="" class="standard">Arvo</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">Viskositeetti, mm²/s (ASTM D445)</td><td width="" height="" class="standard">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">mm²/s @ 100º C</td><td width="" height="" class="standard">10,0</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Tuhkapitoisuus, paino-% (ASTM D874)</td><td width="" height="" class="standard">1,4</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Fosfori, paino-% (ASTM D4951)</td><td width="" height="" class="standard">0,1</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Leimahduspiste, ºC, (ASTM D92)</td><td width="" height="" class="standard">228</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Tiheys @15,6 ºC g/ml, (ASTM D4052)</td><td width="" height="" class="standard">0,849</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Kokonaisemäsluku (ASTM D2896)</td><td width="" height="" class="standard">11</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">MRV -30 ºC:ssä, cP (ASTM D4684)</td><td width="" height="" class="standard">19000</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">HTHS viskositeetti, mPa&bull;s @ 150 ºC (ASTM D4683)</td><td width="" height="" class="standard">3,0</td>
                                        </tr></tbody></table>
                                    <p xmlns="">&nbsp;</p>
                                </div>
                            </td>
