...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fi" lang="fi">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Delvac puskurista puskuriin tuoteopas</title>
        <meta name="keywords" content="Dieselmoottori, Mobil Delvac, puskurista puskuriin, Mobil, Raskaat ajoneuvot, Käyttöajoneuvot, Rekkateollisuus, Dieselöljy, Mobil Delvac 1, Raskaan sarjan ammattilainen, Raskaan kaluston polttoainetalous"/>
        <meta name="description" content="Mobil Delvac&trade; on erikoistunut raskaan kaluston voiteluaineisiin jo yli 80 vuoden ajan. Mobil Delvac tarjoaa työkalun, jonka avulla löydät suosittelemamme tuotteen puskurista puskuriin raskaaseen ajoneuvoosi."/>
        <meta name="language" content="fi"/>
        <meta http-equiv="Content-Language" content="fi"/>
        <meta name="WT.ti" content="Mobil Delvac puskurista puskuriin tuoteopas"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d814c5864");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d814c5864','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d814c5864", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <div id="flashFeature">
                            <img width="680" title="Feature Image" src="Images/media_800x600_bumper-to-bumper-fi.gif" height="500" border="0" alt="Feature Image"/>
                        </div>
                      <script type="text/javascript">
                        var so = new SWFObject("/Finland-Finnish-LCW/Flash/media_800x600_bumper-to-bumper-fi.swf", "xomlandingflash", "680", "500", "8");
            ...
            <div id="subfeatureCallouts">
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d814c5864", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d814c5864", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                </div>
