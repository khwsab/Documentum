    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="http://www.mobil1.co.th/products/where-to-buy.aspx">&#3650;&#3617;&#3610;&#3636;&#3621; 1 &#3648;&#3595;&#3655;&#3609;&#3648;&#3605;&#3629;&#3619;&#3660;</asp:HyperLink>
                    </li>
                </ul><% Response.Write((aL1_1.CssClass == "selected") ? "<script type=\"text/javascript\">addFallback(1,\"http://www.mobil1.co.th/products/where-to-buy.aspx\")</script>" : ""); %></asp:panel>
            <asp:panel visible="true" id="L1_2" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_2" NavigateUrl="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=th-TH&amp;amp;renderMap=true&amp;amp;renderButton=true">&#3612;&#3641;&#3657;&#3649;&#3607;&#3609;&#3592;&#3635;&#3627;&#3609;&#3656;&#3634;&#3618;</asp:HyperLink>
                    </li>
                </ul><% Response.Write((aL1_2.CssClass == "selected") ? "<script type=\"text/javascript\">addFallback(1,\"https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=th-TH&amp;amp;renderMap=true&amp;amp;renderButton=true\")</script>" : ""); %></asp:panel>
            <div class="capBL">
                <div class="capBR"></div>
            </div>
        </div>
