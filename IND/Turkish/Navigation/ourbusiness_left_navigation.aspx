...
aL1_5.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="ourbusiness_sustainability.aspx">sürdürülebilirlik</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_2"  runat="server" NavigateUrl="ourbusiness_energy-efficiency.aspx">enerji verimlili&#287;i</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_3" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_3"  runat="server" NavigateUrl="ourbusiness_productivity.aspx">üretkenlik</asp:HyperLink></li><asp:panel id="L1_3_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_3_L2_1"  runat="server" NavigateUrl="ourbusiness_productivity_industry-expertise.aspx">endüstri uzmanl&#305;&#287;&#305;</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_3_L2_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_3_L2_2"  runat="server" NavigateUrl="ourbusiness_productivity_hydraulic-efficiency.aspx">hidrolik verimlilik</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_4" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_4"  runat="server" NavigateUrl="ourbusiness_industry-events.aspx">Etkinlik Takvimi</asp:HyperLink></li><asp:panel id="L1_4_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_4_L2_1"  runat="server" NavigateUrl="ourbusiness_productivity_industry-expertise.aspx">endüstri uzmanl&#305;&#287;&#305;</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_4_L2_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_4_L2_2"  runat="server" NavigateUrl="ourbusiness_productivity_hydraulic-efficiency.aspx">hidrolik verimlilik</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_5" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_5"  runat="server" NavigateUrl="ourbusiness_equipment-builder-group.aspx">ExxonMobil Ekipman Üreticileri Tak&#305;m&#305;</asp:HyperLink></li></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">h&#305;zl&#305; linkler</h3></div><ul><li><a href="contactus.aspx">global teknik destek</a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>