...
aL1_6.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="lubricationsolutions_industrialproductivity.aspx">üretkenli&#287;i art&#305;r&#305;yoruz</asp:HyperLink></li><asp:panel id="L1_1_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_1"  runat="server" NavigateUrl="lubricationsolutions_industrialproductivity_sustainability.aspx">harekette sürdürülebilirlik</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_2" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_2"  runat="server" NavigateUrl="lubricationsolutions_energyefficiency.aspx">enerji verimlili&#287;i</asp:HyperLink></li><asp:panel id="L1_2_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_1"  runat="server" NavigateUrl="lubricationsolutions_energyefficiency_hydraulicefficiency.aspx">hidrolik verimlili&#287;i</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_3" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_3"  runat="server" NavigateUrl="lubricationsolutions_mobil-serv.aspx">mobil serv ya&#287; analizi</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_4" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_4"  runat="server" NavigateUrl="lubricationsolutions_industryexpertise.aspx">endüstri uzmanl&#305;&#287;&#305;</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_5" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_5"  runat="server" NavigateUrl="lubricationsolutions_equipmentbuildergroup.aspx">ekipman Üreticileri Grubu</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_6" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_6"  runat="server" NavigateUrl="lubricationsolutions_icci_2018.aspx">ICCI 2018</asp:HyperLink></li></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">h&#305;zl&#305; linkler</h3></div><ul><li><a href="contactus.aspx">global teknik destek</a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>