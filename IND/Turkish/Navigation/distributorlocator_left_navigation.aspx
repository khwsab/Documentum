...
aL1_1.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="distributorlocator.aspx">distribütör bul</asp:HyperLink></li></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">h&#305;zl&#305; ba&#287;lant&#305;lar</h3></div><ul><li><a href="contactus.aspx">bize ula&#351;&#305;n</a></li><li><a href="https://www.mobil.com/en/industrial/lubricants/search">hangi ya&#287;?</a></li><li><a href="http://www.exxonmobil.com/pdssearch/search.aspx?chooseLanguage=tr">ürün bilgi formlar&#305;</a></li><li><a target="_new" href="http://www.msds.exxonmobil.com/psims/psims.aspx">malzeme güvenlik bilgi formu (MSDS)</a></li><li><a href="distributorlocator.aspx">distribütör bulma arac&#305;</a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>
