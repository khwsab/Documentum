...
aL1_6.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="yourindustry_energy.aspx">enerji</asp:HyperLink></li><asp:panel id="L1_1_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_1"  runat="server" NavigateUrl="yourindustry_energy_coal.aspx">kömür</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_1_L2_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_2"  runat="server" NavigateUrl="yourindustry_energy_gasturbines.aspx">türbinler&#305;</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_1_L2_3" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_3"  runat="server" NavigateUrl="yourindustry_energy_gasengine.aspx">gaz motoru</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_1_L2_4" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_4"  runat="server" NavigateUrl="yourindustry_energy_oilandgas.aspx">ya&#287; ve gaz</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_1_L2_5" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_5"  runat="server" NavigateUrl="yourindustry_energy_nuclear.aspx">nükleer</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_1_L2_6" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_1_L2_6"  runat="server" NavigateUrl="yourindustry_energy_wind.aspx">rüzgâr</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_2" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_2"  runat="server" NavigateUrl="yourindustry_manufacturing.aspx">üretim</asp:HyperLink></li><asp:panel id="L1_2_L2_1" Runat="server" visible="false"><ul><li><asp:HyperLink id="aL1_2_L2_1"  runat="server" NavigateUrl="yourindustry_manufacturing_food.aspx">g&#305;da ve içecek</asp:HyperLink></li><asp:panel id="L1_2_L2_1_L3_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_1_L3_1"  runat="server" NavigateUrl="yourindustry_manufacturing_food_bakery.aspx">unlu mamulleri</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2_L2_1_L3_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_1_L3_2"  runat="server" NavigateUrl="yourindustry_manufacturing_food_dairy.aspx">süt ürünleri i&#351;leme</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2_L2_1_L3_3" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_1_L3_3"  runat="server" NavigateUrl="yourindustry_manufacturing_food_meat.aspx">et i&#351;leme</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_2_L2_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_2"  runat="server" NavigateUrl="yourindustry_manufacturing_plastics.aspx">plastik</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2_L2_3" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_2_L2_3"  runat="server" NavigateUrl="yourindustry_manufacturing_machining.aspx">tala&#351;l&#305; imalat</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><asp:panel id="L1_3" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_3"  runat="server" NavigateUrl="yourindustry_mining_offhighway.aspx">madencilik/in&#351;aat</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_4" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_4"  runat="server" NavigateUrl="yourindustry_pulpandpaper.aspx">ka&#287;&#305;t hamuru ve ka&#287;&#305;t</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_5" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_5"  runat="server" NavigateUrl="yourindustry_primarymetals.aspx">demirçelik</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_6" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_6"  runat="server" NavigateUrl="yourindustry_process.aspx">proses</asp:HyperLink></li></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">h&#305;zl&#305; linkler</h3></div><ul><li><a href="ourbusiness_events.aspx">etkinlik takvimi</a></li><li><a href="technicalresources_technical-topics.aspx">teknik konular</a></li><li>endüstri &#351;emalar&#305;</li><li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="yourindustry_energy_wind_schematic.aspx">rüzgar türbini</a></li><li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="yourindustry_energy_coal_schematic.aspx">kömür yak&#305;tl&#305; termik santral</a></li><li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="yourindustry_pulpandpaper_plant_schematic.aspx">ka&#287;&#305;t hamuru ve ka&#287;&#305;t tesisi</a></li><li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="yourindustry_manufacturing_machining_schematic.aspx">atölyeler</a></li><li>&nbsp;&nbsp;&nbsp;&nbsp;<a href="yourindustry_energy_gasengine_gasschematic.aspx">gaz ve buhar türbinli</a></li><li><a href="yourindustry.aspx">daha fazla &#351;ema</a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>