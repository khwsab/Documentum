...
HeaderText="teknik yard&#305;m";
			...
			{
				HeaderLoadPage();	
				//this.Load += new System.EventHandler(this.HeaderLoadPage);
			}
		#endregion
				</script>
				<!--stopindex-->
...
<script type="text/javascript">
    ...
    function selectIndexChange(ddl)
    {
        ...
        window.location.href = dictionary[ddl.value]['url'];
				...
				</td></tr></table></div><a href="/IND/Turkish/default.aspx"><img title="" src="/IND/English/Images/153x25_header_mobil_il.gif" longdesc="" id="logo" border="0" alt="Mobil Industrial Lubricants"></a><div style="visibility: Visible;height:1.4em;" id="search"><form onSubmit="javascript: return CheckInput()" name="frmSimpleSearch" method="get" action="./Search.aspx" style="display:none;"><label for="searchTerms">search terms</label><input value="Anahtar kelimeler" type="text" onClick="javascript: clearBox();" name="q" maxlength="50" id="qt"><input value="mobil" type="hidden" name="site"><input value="/imports/mobil_ind" type="Hidden" name="css"><input type="Hidden" name="BCL" value="/IND/Turkish/Navigation"/><input value="en" type="Hidden" name="la"><input value="lang_en" type="Hidden" name="lr"><input value="mil_en" type="Hidden" name="km"><input value="y" type="Hidden" name="show_km"><input value="xml_no_dtd" type="Hidden" name="output"><input value="default_frontend" type="Hidden" name="client"><input value="description" type="Hidden" name="getfields"><input value="inurl:/IND/Turkish/" type="Hidden" name="as_q"><input value="0" type="Hidden" name="filter"><input value="UTF-8" type="Hidden" name="ie"><input value="10" type="Hidden" name="num"><input value="UTF-8" type="Hidden" name="oe"><span class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="ARA" type="submit" class="middleSubmitBtn"></span></span></form></div><div id="globalNav" style="margin-right:50px;"><ul class="clrfix"><li><asp:HyperLink id="Home_current"  runat="server" NavigateUrl="/IND/Turkish/default.aspx">ana sayfa</asp:HyperLink></li><li><a target="_new" href="http://pds.exxonmobil.com/pdssearch/Search.aspx?chooseLanguage=tr">pds</a></li><li><a target="_new" href="http://www.msds.exxonmobil.com/IntApps/psims/psims.aspx">msds</a></li><li><a href="/IND/Turkish/contactus.aspx">bize ula&#351;&#305;n</a></li><li><a href="/IND/Turkish/contactus_technical-help-desks.aspx">teknik yard&#305;m</a></li></ul></div></div><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="mainNav" class="clrfix"><div class="mnbk"><div class="mnleft"><div class="mnright"><ul><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></ul></div></div></div></div><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" style="width:912px; height:220px" id="navPanel" class="clrfix"><!--#include virtual="../Images/html5/carousel.html"--></div></asp:panel><asp:panel id="HomePanel_1" Runat="server" visible="false"><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="globalHeader" class="clrfix"><div style="height: 30px;" id="globallang"><asp:panel id="LanguageSelectorPanel_1" Runat="server" visible="false"><table><tr><td><img title="Select Language" src="/IND/English/Images/world.gif"  border="0" alt="Select Language"></td><td>SELECT LANGUAGE
...
<script type="text/javascript">
    ...
    function selectIndexChange(ddl)
    {
        ...
        window.location.href = dictionary[ddl.value]['url'];
				...
				</td></tr></table></asp:panel><asp:panel id="LanguageSelectorPanel_2" Runat="server" visible="false"><table><tr><td><img title="Select Language" src="/IND/English/Images/world.gif"  border="0" alt="Select Language"></td><td style="width:200px;">SELECT LANGUAGE<select id="languageSelector" name="languageSelector" class="DropdownClass" onChange="window.location.href=this.value"></select></td></tr></table></asp:panel></div><a href="/IND/Turkish/default.aspx"><img title="" src="/IND/English/Images/153x25_header_mobil_il.gif" longdesc="" id="logo" border="0" alt="Mobil Industrial Lubricants"></a><div style="visibility: Visible;height:1.4em;" id="search"><form onSubmit="javascript: return CheckInput()" name="frmSimpleSearch" method="get" action="./Search.aspx" style="display:none;"><input value="Anahtar kelimeler" type="text" onClick="javascript: clearBox();" name="q" maxlength="50" id="qt"><input value="mobil" type="hidden" name="site"><input value="/imports/mobil_ind" type="Hidden" name="css"><input type="Hidden" name="BCL" value="/IND/Turkish/Navigation"/><input value="en" type="Hidden" name="la"><input value="lang_en" type="Hidden" name="lr"><input value="mil_en" type="Hidden" name="km"><input value="y" type="Hidden" name="show_km"><input value="xml_no_dtd" type="Hidden" name="output"><input value="default_frontend" type="Hidden" name="client"><input value="description" type="Hidden" name="getfields"><input value="inurl:/IND/Turkish/" type="Hidden" name="as_q"><input value="0" type="Hidden" name="filter"><input value="UTF-8" type="Hidden" name="ie"><input value="10" type="Hidden" name="num"><input value="UTF-8" type="Hidden" name="oe"><span class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="ARA" type="submit" class="middleSubmitBtn"></span></span></form></div><div id="globalNav" style="margin-right: 50px;"><ul class="clrfix"><li><a href="/IND/Turkish/default.aspx">ana sayfa</a></li><li><asp:HyperLink id="UtilityNavPanel_1"  runat="server" NavigateUrl="http://pds.exxonmobil.com/pdssearch/Search.aspx?chooseLanguage=tr">pds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_2"  runat="server" NavigateUrl="http://www.msds.exxonmobil.com/IntApps/psims/psims.aspx">msds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_3"  runat="server" NavigateUrl="/IND/Turkish/contactus.aspx">bize ula&#351;&#305;n</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_4"  runat="server" NavigateUrl="/IND/Turkish/contactus_technical-help-desks.aspx">teknik yard&#305;m</asp:HyperLink></li></ul></div></div><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="mainNav" class="clrfix"><div class="mnbk"><div class="mnleft"><div class="mnright"><ul>
							<asp:panel id="BlueNavPanel_Current_None" Runat="server" visible="True"><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_1" Runat="server" visible="False"><li><a href="/IND/Turkish/products.aspx" class="mnNavOn">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_2" Runat="server" visible="False"><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx" class="mnNavOn">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_3" Runat="server" visible="False"><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false" class="mnNavOn">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_4" Runat="server" visible="False"><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx" class="mnNavOn">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx">ya&#287;lama çözümleri</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_5" Runat="server" visible="False"><li><a href="/IND/Turkish/products.aspx">ürünler</a></li><li><a href="/IND/Turkish/yourindustry.aspx">endüstriniz</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=tr-TR&amp;renderMap=true&amp;renderButton=false">nereden sat&#305;n al&#305;nabilir</a></li><li><a href="/IND/Turkish/technicalresources.aspx">teknik kaynaklar</a></li><li><a href="/IND/Turkish/lubricationsolutions.aspx" class="mnNavOn">ya&#287;lama çözümleri</a></li></asp:panel></ul></div></div></div></div></asp:panel>
