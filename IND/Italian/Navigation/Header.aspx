        ...
        window.location.href = dictionary[ddl.value]['url'];
						...
						<div id="globalNav" style="margin-right: 50px;">
							<ul class="clrfix">
								...
								<li><a target="" href="http://pds.exxonmobil.com/pdssearch/Search.aspx?chooseLanguage=es">pds</a></li>
...
<script type="text/javascript">
    ...
    function selectIndexChange(ddl)
    {
        ...
        window.location.href = dictionary[ddl.value]['url'];
									...
									<div id="globalNav" style="margin-right: 50px;"><ul class="clrfix"><li><a href="/IND/Italian/default.aspx">home</a></li><li><asp:HyperLink id="UtilityNavPanel_1"  runat="server" NavigateUrl="http://pds.exxonmobil.com/pdssearch/Search.aspx?chooseLanguage=es">pds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_2"  runat="server" NavigateUrl="http://www.msds.exxonmobil.com/IntApps/psims/psims.aspx">msds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_3"  runat="server" NavigateUrl="contactus_technical-help-desks.aspx">supporto tecnico</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_4"  runat="server" NavigateUrl="contactus.aspx">contattaci</asp:HyperLink></li></ul></div></div><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="mainNav" class="clrfix"><div class="mnbk"><div class="mnleft"><div class="mnright"><ul>
