...
aL1_4.CssClass="selected"; 
} if(SW=="industry-expertise"){
aL1_4_L2_1.CssClass="selected"; 
} if(FW=="productivity"){
L1_4_L2_2.Visible=true; 
aL1_4.CssClass="selected"; 
} if(SW=="hydraulic-efficiency"){
aL1_4_L2_2.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="ourbusiness_sustainability.aspx">sostenibilità</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_2"  runat="server" NavigateUrl="ourbusiness_energy-efficiency.aspx">efficienza energetica</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_3" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_3"  runat="server" NavigateUrl="ourbusiness_industry-events.aspx">calendario eventi</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_4" Runat="server" visible="true"><ul><li><asp:HyperLink id="aL1_4"  runat="server" NavigateUrl="ourbusiness_productivity.aspx">produttività</asp:HyperLink></li><asp:panel id="L1_4_L2_1" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_4_L2_1"  runat="server" NavigateUrl="ourbusiness_productivity_industry-expertise.aspx">esperienza settoriale</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_4_L2_2" Runat="server" visible="false"><ul><li class="endpoint"><asp:HyperLink id="aL1_4_L2_2"  runat="server" NavigateUrl="ourbusiness_productivity_hydraulic-efficiency.aspx">efficienza idraulica</asp:HyperLink></li></ul></asp:panel></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">link rapidi</h3></div><ul><li><a href="contactus.aspx">help desk tecnico</a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>