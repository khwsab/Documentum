				...
				<!-- Set 'expires' in http header, start --><% string cacheExpireDateStr="11/4/2018 4:15:08 AM";
...
Selettore prodotti Looble<sup>SM</sup> (EN)<br><a title="This link will open a new window." target="_new" href="/Apps/ILS/default_EN.aspx">Trovate il lubrificante giusto per le vostre esigenze</a></p></div></div></div><div id="mainContent"><br/><div class="img150 left"><img xmlns="" title="Mobil SHC serie 800, olio lubrificante per turbine " src="Images/article_150x150_mobil-shc-800-series.jpg" longdesc="" border="0" alt="Mobil SHC serie 800, olio lubrificante per turbine "></div><p xmlns=""><span style=" font-size: x-large;"><b>Mobil SHC&trade; serie 800</b></span></p><p xmlns=""><span style=" font-size: large;"><b>Oli ad alte prestazioni per turbine</b></span></p><p xmlns="">Gli oli sintetici per turbine Mobil SHC serie 800 sono formulati per soddisfare le richieste di alcune delle più impegnative applicazioni delle turbine a gas. Presentano un&rsquo;eccellente fluidità a basse temperature e un&rsquo;ottima resistenza al deterioramento ad alte temperature, ben superiori alle capacità dei nostri migliori oli minerali.</p><p xmlns=""><b>Protezione straordinaria</b><br>
Per formulare gli oli Mobil SHC serie 800, i nostri esperti hanno miscelato specifici additivi per massimizzare i vantaggi degli oli sintetici e contribuire ad aumentare la durata dell'olio, a controllare i depositi e a limitare la decomposizione termica e chimica rispetto agli oli convenzionali. Le prestazioni bilanciate degli oli Mobil SHC serie 800 possono aiutarvi a risolvere i problemi legati alla lubrificazione delle turbine a gas.</p><p xmlns=""></p><p xmlns=""><a title="This link will open a new window." target="_new" href="https://www.mobil.com/industrial/~/media/files/global/us/industrial/performance-profiles/mobil-shc-800-series-performance-profile.pdf">Scheda informativa Mobil SHC&trade; serie 800<img src="/Images/Icons/icon_pdf_whitespace.jpg" border="0" alt=""></a> (EN)</p><p xmlns="">&nbsp;</p><div id="tabbed_table"><table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0"><tr id="tabNav"><td style="height:1px; padding-bottom:-10px; " colspan="5"><div style="z-index:100; " id="divTabs"><ul><li onmouseover="if(this.className!='current')this.className='highlight';" onmouseout="if(this.className!='current')this.className=''" class="current" id="Prerogative a Benefici"><a href="#" onclick="javascript:showTab('Prerogative a Benefici');">Prerogative a Benefici</a></li><li onmouseover="if(this.className!='current')this.className='highlight'" onmouseout="if(this.className!='current')this.className=''" id="Caratteristiche Tipiche"><a href="#" onclick="javascript:showTab('Caratteristiche Tipiche');">Caratteristiche Tipiche</a></li><li onmouseover="if(this.className!='current')this.className='highlight'" onmouseout="if(this.className!='current')this.className=''" id="Applicazioni"><a href="#" onclick="javascript:showTab('Applicazioni');">Applicazioni</a></li></ul></div></td></tr><tr id="trTabContent">
