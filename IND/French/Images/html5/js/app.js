...
/*--- SLIDE 1 ANIMATION KEYSTONES ----*/
	...
	$('#tc-carousel #application-banner #cursor').on("webkitAnimationEnd oanimationend oAnimationEnd msAnimationEnd animationend", function() {
		   EndAnim(4);	
		}); 
		
	$('#tc-carousel #application-banner .first').on("webkitAnimationStart oanimationstart oAnimationStart msAnimationStart animationstart", function() {
			StartAnim(4);
	}); 
  
	/*--- SLIDE 5 ANIMATION KEYSTONES ----*/
	$('#tc-carousel #updown-banner .btn-more').on("webkitAnimationEnd oanimationend oAnimationEnd msAnimationEnd animationend", function() {
			EndAnim(5);
		}); 
		
	$('#tc-carousel #updown-banner .first .top').on("webkitAnimationStart oanimationstart oAnimationStart msAnimationStart animationstart", function() {
    StartAnim(5);
	}); 
      ...
      case activeS == 2:
        ...
        $('#tc-carousel #menu').delay(5500).animate({ opacity: "1", right: "0px" }, 1000);
			...
			case activeS == 4:
				...
				StartAnim(4);
				EndAnim(4);
        $('#application-banner #leftside-content p').css('opacity', '0');
        $('#application-banner #rightside-content #cursor').css({left: '-100px', top: '-80px'});
        $('#application-banner #rightside-content').css('background-position', '440px 0');
        $('#application-banner #leftside-content p.first').animate({opacity: '1'}, 1000);
        $('#application-banner #leftside-content p.second').delay(1000).animate({opacity: '1'}, 1000);
        $('#application-banner #leftside-content p.third').delay(2000).animate({opacity: '1'}, 1000);
        $('#application-banner #leftside-content p.last').delay(3000).animate({opacity: '1'}, 1000);
        $('#application-banner #rightside-content #cursor').delay(2000).animate({
          top: '140px',
          left: '-50px'
        }, 2000).animate({
          width: '67px',
        ...
        $('#updown-banner #gradient').css('opacity', '0');
        $('#updown-banner #gradient .btn-more').css('opacity', '0');
        $('#updown-banner #gradient p').css('opacity', '0');
        $('#updown-banner #gradient img').css('opacity', '0');
        $('#updown-banner .top').css('top', '-130px');
        $('#updown-banner .bottom').css('bottom', '-130px');
        $('#updown-banner .first .top').animate({'top': '30px'}, 1000);
        $('#updown-banner .second .top').delay(1000).animate({'top': '30px'}, 1000);
        $('#updown-banner .third .top').delay(2000).animate({'top': '30px'}, 1000);
        $('#updown-banner .first .bottom').animate({'bottom': '30px'}, 1000);
        $('#updown-banner .second .bottom').delay(1000).animate({'bottom': '30px'}, 1000);
        $('#updown-banner .third .bottom').delay(2000).animate({'bottom': '30px'}, 1000);
        $('#updown-banner #gradient').delay(3000).animate({opacity: '1'}, 1000);
        $('#updown-banner #gradient p, #updown-banner #gradient img').delay(4000).animate({opacity: '1'}, 1000);
        $('#updown-banner #gradient .btn-more').delay(5000).animate({opacity: '1'}, 1000);
		}
	}
