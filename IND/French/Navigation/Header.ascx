...
BackGrdImage="";
HeaderText="votre secteur d&rsquo;activité";
...
<script type="text/javascript">
    var dictionary = {'de-german' : {'url' : 'https://www.mobilindustrial.com/IND/german/default.aspx', 'languageCode' : 'de'}, 'es-spanish' : {'url' : 'https://www.mobilindustrial.com/IND/spanish', 'languageCode' : 'es'}, 'en-english' : {'url' : 'https://www.mobilindustrial.com/IND/english', 'languageCode' : 'en'}, 'tr-turkish' : {'url' : 'https://www.mobilindustrial.com/IND/turkish/default.aspx', 'languageCode' : 'tr'}, 'ru-russian' : {'url' : 'https://www.mobilindustrial.com/IND/russian/default.aspx', 'languageCode' : 'ru'}, 'it-italian' : {'url' : 'https://www.mobilindustrial.com/IND/italian/default.aspx', 'languageCode' : 'it'}, 'fr-french' : {'url' : 'https://www.mobilindustrial.com/IND/french/default.aspx', 'languageCode' : 'fr'}, 'zh-chinese' : {'url' : 'https://www.mobilindustrial.com/IND/chinese/default.aspx', 'languageCode' : 'zh'}};
...
<script type="text/javascript">
    ...
    function selectIndexChange(ddl)
    {
        ...
        window.location.href = dictionary[ddl.value]['url'];
				...
				</td></tr></table></asp:panel><asp:panel id="LanguageSelectorPanel_2" Runat="server" visible="false"><table><tr><td><img title="Select Language" src="/IND/English/Images/world.gif"  border="0" alt="Select Language"></td><td style="width:200px;">SELECT LANGUAGE<select id="languageSelector" name="languageSelector" class="DropdownClass" onChange="window.location.href=this.value"></select></td></tr></table></asp:panel></div><a href="/IND/French/default.aspx"><img title="" src="/IND/English/Images/153x25_header_mobil_il.gif" longdesc="" id="logo" border="0" alt="Mobil Industrial Lubricants"></a><div style="visibility: Visible;height: 1.4em;" id="search"><form onSubmit="javascript: return CheckInput()" name="frmSimpleSearch" method="get" action="./Search.aspx" style="display:none;"><input value="mots-clés" type="text" onClick="javascript: clearBox();" name="q" maxlength="50" id="qt"><input value="mobil" type="hidden" name="site"><input value="/imports/mobil_ind" type="Hidden" name="css"><input type="Hidden" name="BCL" value="/IND/French/Navigation"/><input value="en" type="Hidden" name="la"><input value="lang_en" type="Hidden" name="lr"><input value="mil_en" type="Hidden" name="km"><input value="y" type="Hidden" name="show_km"><input value="xml_no_dtd" type="Hidden" name="output"><input value="default_frontend" type="Hidden" name="client"><input value="description" type="Hidden" name="getfields"><input value="inurl:/IND/French/" type="Hidden" name="as_q"><input value="0" type="Hidden" name="filter"><input value="UTF-8" type="Hidden" name="ie"><input value="10" type="Hidden" name="num"><input value="UTF-8" type="Hidden" name="oe"><span class="barbgleftSumbit"><span class="barbgrightSubmit"><input value="recherche" type="submit" class="middleSubmitBtn"></span></span></form></div><div id="globalNav" style="margin-right: 50px;"><ul class="clrfix"><li><a target="_new" href="http://www.mobilindustrial.com/ind/french/default.aspx">accueil</a></li><li><asp:HyperLink id="UtilityNavPanel_1"  runat="server" NavigateUrl="http://www.exxonmobil.com/pdssearch/search.aspx?chooseLanguage=fr">pds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_2"  runat="server" NavigateUrl="http://www.msds.exxonmobil.com/psims/psims.aspx">msds</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_3"  runat="server" NavigateUrl="/IND/French/contactus.aspx">nous contacter</asp:HyperLink></li><li><asp:HyperLink id="UtilityNavPanel_4"  runat="server" NavigateUrl="/IND/French/contactus_technical-help-desks.aspx">assistance technique</asp:HyperLink></li></ul></div></div><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="mainNav" class="clrfix"><div class="mnbk"><div class="mnleft"><div class="mnright"><ul>
							<asp:panel id="BlueNavPanel_Current_None" Runat="server" visible="True"><li><a href="/IND/french/products.aspx">produits</a></li><li><a href="/IND/French/yourindustry.aspx">votre secteur d&rsquo;activité</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx">ressources techniques</a></li><li><a href="lubricationsolutions.aspx">Nos solutions lubrification</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_1" Runat="server" visible="False"><li><a href="/IND/french/products.aspx" class="mnNavOn">produits</a></li><li><a href="/IND/French/yourindustry.aspx">votre secteur d&rsquo;activité</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx">ressources techniques</a></li><li><a href="lubricationsolutions.aspx">Nos solutions lubrification</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_2" Runat="server" visible="False"><li><a href="/IND/french/products.aspx">produits</a></li><li><a href="/IND/French/yourindustry.aspx" class="mnNavOn">votre secteur d&rsquo;activité</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx">ressources techniques</a></li><li><a href="lubricationsolutions.aspx">Nos solutions lubrification</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_3" Runat="server" visible="False"><li><a href="/IND/french/products.aspx">produits</a></li><li><a href="/IND/French/yourindustry.aspx">votre secteur d&rsquo;activité</a></li><li><a href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false" class="mnNavOn">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx">ressources techniques</a></li><li><a href="lubricationsolutions.aspx">Nos solutions lubrification</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_4" Runat="server" visible="False"><li><a href="/IND/french/products.aspx">produits</a></li><li><a href="/IND/French/yourindustry.aspx">votre secteur d&rsquo;activité</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx" class="mnNavOn">ressources techniques</a></li><li><a href="lubricationsolutions.aspx">Nos solutions lubrification</a></li></asp:panel><asp:panel id="BlueNavPanel_Current_5" Runat="server" visible="False"><li><a href="/IND/french/products.aspx">produits</a></li><li><a href="/IND/French/yourindustry.aspx">votre secteur d&rsquo;activité</a></li><li><a target="_new" href="https://www.mobil.com/industrial/lubricants-distributors/externallocator?culture=fr-FR&amp;renderMap=true&amp;renderButton=false">points de vente</a></li><li><a href="/IND/french/technicalresources.aspx">ressources techniques</a></li><li><a href="lubricationsolutions.aspx" class="mnNavOn">Nos solutions lubrification</a></li></asp:panel></ul></div></div></div></div></asp:panel>
