...
aL1_3.CssClass="selected"; 
		...
		{    
			...
			<!--stopindex-->
			<!--googleoff: index-->
			<a xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" href="#mainContent" class="skip">Skip to Main Content</a><div xmlns:xalan-nodeset="org.apache.xalan.xslt.extensions.Nodeset" xmlns:java="http://xml.apache.org/xslt/java" xmlns:fo="http://www.w3.org/1999/XSL/Format" id="sideBar" class="clrfix"><div class="subnav"><div class="subL"><div class="subR"><div class="capTL"><div class="capTR"></div></div><asp:panel id="L1_1" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_1"  runat="server" NavigateUrl="technicalresources_case-studies.aspx">ètudes de cas</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_2" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_2"  runat="server" NavigateUrl="technicalresources_technical-topics.aspx">questions techniques</asp:HyperLink></li></ul></asp:panel><asp:panel id="L1_3" Runat="server" visible="true"><ul><li class="endpoint"><asp:HyperLink id="aL1_3"  runat="server" NavigateUrl="technicalresources_schematics.aspx">schémas</asp:HyperLink></li></ul></asp:panel><div class="capBL"><div class="capBR"></div></div></div></div></div><div class="quicklinks"><div class="headerbar"><h3 class="nolink">liens utiles</h3></div><ul><li><a href="contactus.aspx">service international d&rsquo;assistance technique</a></li><li><a target="_new" href="https://mobilserv.mobil.com/fr/">Mobil Serv Lubricant Analysis<sup>SM</sup></a></li></ul></div>
<!--googleon: index-->
			<!--startindex-->
			</div>