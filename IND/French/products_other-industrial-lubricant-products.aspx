...
<head>
	...
	<meta name="keywords" content="Lubrifiant industriel, lubrifiants industriels, graisses hautes performances, huiles pour compresseurs, fluides de coupe pour le travail des métaux, lubrifiants Mobil" />
	<meta name="description" content="Trouvez les lubrifiants industriels Mobil&trade; adaptés à vos applications, pour un fonctionnement optimal de vos équipements." />
	...
	<div id="container">
		...
		<div id="mainPanel" class="clrfix">
			...
			<div id="mainContent"><br />
				...
				<p xmlns=""><b><span style=" font-size: large;">Trouvez les lubrifiants Mobil&trade; adaptés à vos besoins</span></b></p>
				<p xmlns="">Si le produit recherché ne figure pas dans la liste ci-dessous, veuillez consulter les <a target=""
					 ...
					 title="This link will open a new window." target="_new" href="http://www.msds.exxonmobil.com/IntApps/psims/psims.aspx">Fiches
						de Données de Sécurité</a> pour obtenir des informations actualisées.</p>
				<p xmlns="">Contactez votre <a title="" target="" href="distributorlocator.aspx">distributeur local de lubrifiants
						industriels</a>, pour vous assurer de la bonne adéquation des produits à vos applications et de leur
					disponibilité locale effective, ou <a title="" target="" href="contactus.aspx">contactez nous.</a></p>
				<ul xmlns="">
					...
					<li><a title="This link will open a new window." target="_new" href="http://www.mobil.com/Egypt-English-LCW/heavydutyoils_products_greases_mobilux-ep-series.aspx">Mobilux&trade;
							EP</a> (EN)</li>
					<li><a title="" target="" href="products_vactra.aspx">Mobil Vactra&trade; numérotée</a></li>
				</ul>
				<p xmlns="">&nbsp;</p>
			</div>
		</div>
