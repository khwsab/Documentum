	...
	<script type="text/javascript">     
		$( document ).ready(function() {
			MobilSchematics.init({
					element:        '#app',
					configURL:      '/Imports/schematics/data/data_fr/nuclear.json',
                ...
                <div id="titletoolbar">
					...
					<a onclick="dcsMultiTrack('WT.ti', 'add%20page%20to%20favorites', 'WT.cg_n', 'Advertisement%20Toolbox');" href="javascript:addbookmark()">
                     ...
                     <div class="container">
						...
						<p><a href="/ind/english/files/schm_nuclear.pdf">Découvrez le schéma descriptif (PDF - En Anglais uniquement)</a></p>
					</div> <!-- /.container -->
