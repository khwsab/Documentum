...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=10">
        <title>Brandstofverbruik verminderen en emissieniveaus verlagen</title>
        <meta name="keywords" content="Mobil Delvac 1 LE 5W-30, Brandstofverbruik verminderen, emissieniveaus verlagen, CO2-vermindering, Mobil Delvac 1, Mobil Delvac, dieselmotoroliën"/>
        <meta name="description" content="Mobil Delvac 1™ LE 5W-30-motorolie helpt Nederlands transportbedrijf om brandstof te besparen"/>
        <meta name="date" content="2011-01-01"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Productselector voor oliën voor bedrijfsvoertuigen"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d817d591d");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d817d591d','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    ...
                    <div id="mainFeature">
                        <p xmlns=""> 
                                <iframe src="pop/infographic-widget/index.html" width="690" height="2100" frameborder="0"></iframe></p> </div>
            <div id="subfeatureCallouts">
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d817d591d", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d817d591d", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                </div>
