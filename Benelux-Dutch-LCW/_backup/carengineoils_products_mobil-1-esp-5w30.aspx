...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="nl" lang="nl">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; en Benelux | Motoroli�n | Producten | Mobil 1&trade; ESP 5W-30</title>
        <meta name="keywords" content="ESP 5W-30, motor olie, motor oli�n, smeermiddel mobil 1 esp,&nbsp; motoroli�n, synthetisch, syntetisch, synthetische stoffen, smeermiddelen, smering, smeer, olie, oli�n, vet, vetten, consistentvet, mobil, exxonmobil, exxon, Mobil1, Mobil 1, BP, Shell, motorsport, F1, 1, Lewis Hamilton, McLaren, castrol"/>
        <meta name="description" content="&nbsp;Meer informatie over ESP 5W-30"/>
        <meta name="date" content="2011-09-01"/>
        <meta name="language" content="nl"/>
        <meta http-equiv="Content-Language" content="nl"/>
        <meta name="WT.ti" content="Mobil&trade; en Benelux | Motoroli�n | Producten | Mobil 1&trade; ESP 5W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8206f72f");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8206f72f','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8206f72f', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        ...
                        <div class="relatedContent">
                            <p xmlns="">Koop deze motorolie bij een van de Esso Stations</p>&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left">
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8206f72f', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Eigenschappen Content">
                                    <p xmlns="">Mobil 1 ESP 5W-30 bestaat uit een gepatenteerd mengsel van hoogtechnologische componenten, geformuleerd om compatibel te zijn met de nieuwste roetdeeltjesfilters voor dieselmotoren (Diesel Particulate Filters/DPF) en katalysatoren voor benzinemotoren (Gasoline Catalytic Converters/CAT). Mobil 1 ESP 5W-30 werd ontworpen voor uitstekende prestaties en bescherming in combinatie met verbeterde brandstofbesparing. De belangrijkste eigenschappen en voordelen zijn:</p>
                                    <p xmlns="">
                                        <table width="100%" summary="" class="standard" cellspacing="0" border="0">
                                            <thead>
                                                <tr>
                                                    <th width="" scope="col" height="" class="standard">Eigenschappen</th><th width="" scope="col" height="" class="standard">Voordelen en potenti�le besparingen</th>
                                                </tr>
                                            </thead><tbody><tr>
                                            ...
                                            <tr>
                                                <td width="" height="" class="standard">Uitstekende thermische en oxidatiestabiliteit</td><td width="" height="" class="standard">Vermindert veroudering van de olie, wat resulteert in langere bescherming en verlengde verversingsintervallen</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="" height="" class="standard">Verbeterde wrijvingseigenschappen</td><td width="" height="" class="standard">Beter brandstofrendement</td>
                                            </tr>
                                            <tr>
                                                <td width="" height="" class="standard">Uitstekende eigenschappen bij lage temperaturen</td><td width="" height="" class="standard">Snel starten bij koude temperaturen en ultrasnelle bescherming<br>
            Verlengde levensduur van de motor en het elektrisch systeem</td>
                                            </tr></tbody></table>
                                    </p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Toepassingen Content">
                                    ...
                                    <ul xmlns="">
                                        <li>Mobil 1 ESP 5W-30 is bijzonder geschikt voor extreme omstandigheden waar conventionele oli�n vaak niet kunnen presteren.</li>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 ESP 5W-30 heeft de volgende fabrikants goedkeuringen:&nbsp;&nbsp; <br>
...
PSA B712290</p>
                                    ...
                                    <p xmlns="">
                                        <strong>Mobil 1 ESP 5W-30 bereikt of overtreft de eisen van:&nbsp;&nbsp; <br>

                                        </strong>API SN, SM, SL, SJ&nbsp; <br>
ACEA C2, C3<strong> </strong>
                                    </p>

                                    <p xmlns="">
                                        <strong>Volgens ExxonMobil, Mobil 1 ESP 5W-30 heeft dit kwaliteitsniveau:&nbsp;&nbsp; <br>
...
Volkswagen (Diesel) 505 00 / 506 00</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Techn. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil 1 ESP 5W-30</th><th width="" scope="col" height="" class="standard">Waarde</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">SAE klasse</td><td width="" height="" class="standard">5W-30</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Viscositeit, ASTM D 445</td><td width="" height="" class="standard">11,8</td>
                                        </tr>
                                        <tr>
