...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="nl" lang="nl">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; en Benelux | Motoroliën | Producten | Mobil Super&trade; 3000 Formula R 5W-30</title>
        <meta name="keywords" content="Mobil Super 3000 Formula R 5W-30, mobil 1 esp, motorolie, motoroliën, mobile, synthetisch, syntetisch, synthetische stoffen, smeermiddelen, smering, smeer, olie, oliën, vet, vetten, consistentvet, mobil, exxonmobil, exxon, Mobil1, Mobil 1, BP, Shell, motorsport, F1, Formula 1, Lewis Hamilton, McLaren, castrol"/>
        <meta name="description" content="Mobil Super&trade; 3000 Formula R 5W-30"/>
        <meta name="date" content="2011-01-01"/>
        <meta name="language" content="nl"/>
        <meta http-equiv="Content-Language" content="nl"/>
        <meta name="WT.ti" content="Mobil&trade; en Benelux | Motoroliën | Producten | Mobil Super&trade; 3000 Formula R 5W-30"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81449f5a");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81449f5a','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81449f5a', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        ...
                        <div class="relatedContent">
                            <p xmlns="">Koop Mobil Super&trade; 3000 Formula R 5W-30 bij een van de Strategische Distributeurs</p>&#160;</div>
                    </div>
                    <div class="related">
                        <div style="float:left">
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81449f5a', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil Super 3000 Formula R 5W-30 is een hoog presterende motorolie met een heel laag as gehalte. Deze olie is ontwikkeld om bij te dragen tot een langere levensduur en betere efficiëntie van voertuig uitlaat emissie reductie systemen in zowel diesel- als benzinewagens.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81449f5a', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Eigenschappen Content">
                                    <ul xmlns="">
                                        <li>Draagt bij tot de efficiëntie van uitlaat emissie reductie systemen in zowel diesel- als benzinewagens.</li>
                                        <li>Staat verlengd gebruik toe bij verhoogde temperaturen zonder oxiderende verdikking van de olie of olieafbraak.</li>
                                        <li>Geeft uitmuntende vloeibaarheid bij lage temperaturen, wat gemakkelijk starten in de winter en snelle olie circulatie in de motor mogelijk maakt.</li>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Techn. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">Mobil Super 3000 Formula R 5W-30&nbsp;</th><th width="" scope="col" height="" class="standard">Waarde</th>
                                            </tr>
                                        </thead><tbody><tr>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">cSt&nbsp;bij 100 ºC</td><td width="" height="" class="standard">11.7</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">As getal, gew %, ASTM D 874</td><td width="" height="" class="standard">0.5</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Fosfor gehalte, gew %, ASTM D 4951</td><td width="" height="" class="standard">0.05</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Vlampunt, °C, ASTM D 93</td><td width="" height="" class="standard">200</td>
                                        </tr>
                                        <tr>
