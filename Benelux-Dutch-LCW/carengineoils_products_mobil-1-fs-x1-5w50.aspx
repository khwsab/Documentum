...
<%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="nl" lang="nl">
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81edb03a");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81edb03a','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81edb03a', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all --></div>
                <div id="mainContent_thin"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d81edb03a', '/Content',false,'../forms/LCWProductDetails','','825px','750px','Product Detail Overview','','pencil.gif','200px');</script><!-- googleon: all -->
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil 1&trade; is 's werelds toonaangevende merk voor synthetische motorolie die een ultieme prestatie en bescherming levert. De Mobil 1 technologie laat uw motor als nieuw werken. Mobil 1&trade; FS x1 5W-50 is een synthetische motorolie met geavanceerde prestaties, ontworpen om een uitzonderlijk reinigingsvermogen te bieden.</p>
                    </div>
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81edb03a', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Eigenschappen Content">
                                    <p xmlns="">Mobil 1&trade; FS x1 5W-50 is samengesteld uit een gepatenteerd mengsel van high-performance synthetische basisoliën, versterkt met een nauwkeurig gebalanceerd componentensysteem die het volgende biedt:</p>

                                    <ul xmlns="">

                                        <li>Uitstekende slijtagebescherming en smering gedurende de gehele olieverversingsinterval.</li>

                                        <li>Uitstekende bescherming van uw motor doordat bijgedragen wordt aan het voorkomen van schadelijke afzettingen&nbsp;&nbsp;&nbsp;&nbsp;</li>

                                        <li>Verbeterde reinigingstechnologie voor auto's met meer kilometers; 100.000km +</li>

                                        <li>Verbeterde bescherming tegen variabele brandstofkwaliteit*</li>

                                        <li>Bescherming voor uw motor gedurende start bij lage temperaturen</li>

                                    </ul>

                                    <p xmlns="">* Prestatie vergeleken met standaardtesten in de industrie die brandstoffen gebruiken ontwikkeld om opbouw van afzettingen te bevorderen.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Toepassingen Content">
                                    <p xmlns="">Mobil 1 FS x1 5W-50 wordt aanbevolen voor veel soorten voertuigen met meer kilometers; &gt; 100.000 km.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 voldoet aan of overtreft de vereisten van:</strong>
                                        <br>
API SN, SM, SL<br>
ACEA A3/B3, A3/B4</p>

                                    <p xmlns="">
                                        <strong>Mobil 1 FS x1 5W-50 is goedgekeurd door de volgende fabrikanten:</strong>
                                        <br>
...
PORSCHE A40</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Techn. Details Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard"><strong>Mobil 1 FS x1 5W-50</strong></th><th width="" scope="col" height="" class="standard">&nbsp;</th>
                                            </tr>
                                        </thead><tbody><tr>
                                            <td width="" height="" class="standard">&nbsp;Viscositeit bij 40C (ASTM D445)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td width="" height="" class="standard">&nbsp;101</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Vlampunt, ºC, (ASTM D 92)&nbsp;</td><td width="" height="" class="standard">&nbsp;239</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Stolpunt, °C (ASTM D 97)</td><td width="" height="" class="standard">&nbsp;-45</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">Dichtheid bij 15 °C, g/ml (ASTM D4052)</td><td width="" height="" class="standard">&nbsp;0,85</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
