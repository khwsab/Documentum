    ...
    <div class="subL">
        <div class="subR">
            ...
            <asp:panel visible="true" id="L1_1" Runat="server">
                <ul>
                    <li class="endpoint">
                        <asp:HyperLink runat="server" id="aL1_1" NavigateUrl="/AP-English-LCW/industrialspecialty.aspx">industrial &amp; specialty lubricants</asp:HyperLink>
                    </li>
