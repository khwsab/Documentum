<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebTrendsJs.aspx.cs" Inherits="XOM.ILS.HTMLSelector.Script.WebTrendsJs" %>

// WebTrends SmartSource Data Collector Tag
// Version: 9.4.0     
// Tag Builder Version: 4.1
// Created: 5/14/2013 2:49:07 AM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = "<%= DCSID %>";
    this.domain = "<%= SDCDomain %>";
    this.timezone = 7;
    this.enabled = true;
    this.i18n = false;
