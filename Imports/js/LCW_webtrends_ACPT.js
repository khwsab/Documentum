...
// Created: 6/27/2011 6:32:46 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsoyuil6p8ekkvbtaqch9ybv_7z4x";
	this.domain="www.acpt.sdc.exxonmobil.com";
	this.timezone=-6;
	this.fpcdom=".acpt.mobil.com";
	this.onsitedoms="www.acpt.mobil.com";
...
// BDE 11/7/12: Added additional filter on if statement for EU Cookies options
WebTrends.prototype.dcsGetId=function(){
	if (this.enabled&&(document.cookie.indexOf(this.fpc+"=")==-1) && (document.cookie.indexOf("WTLOPTOUT=")==-1) && (typeof enableCookies != 'undefined' && enableCookies == 'true')) {
...
WebTrends.prototype.dcsFPC=function(){
	...
	// BDE 11/7/12: Added if block to exit function immediately if cookies not accepted.
	if (typeof enableCookies != 'undefined' && enableCookies == 'false') {
		return;
	}
	var WT=this.WT;
	var name=this.fpc;
