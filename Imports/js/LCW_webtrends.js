...
// Created: 8/26/2013 5:50:41 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs7b70kq8s9linggzehtqwpi_2c9l";
	this.domain="www.sdc.exxonmobil.com";
	this.timezone=-6;
	this.onsitedoms="www.mobil.com";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,ppt,pptx,flv,mp4";
...
WebTrends.prototype.dcsGetId=function(){
	if (this.enabled&&(document.cookie.indexOf(this.FPCConfig.name+"=")==-1)&&(document.cookie.indexOf("WTLOPTOUT=")==-1) && this.TPCConfig.enabled && (typeof enableCookies != 'undefined' && enableCookies == 'true')){
