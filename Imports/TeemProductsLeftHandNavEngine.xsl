...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:import href="NavigationMenuEngine.xsl"/>
	...
	<xsl:template match="Menu">
			...
			<!--googleoff: index-->
					...
					<xsl:choose>
					<xsl:when test="($desiredURL='/USA-English/Lubes/Products_Services/Products_Services_Collection.asp')" >
						<table width="180" cellpadding="0" cellspacing="0" border="0">
						  <tr>
						    <td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="13" height="1" alt="" border="0" /></td>
								<td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="13" height="1" alt="" border="0" /></td>
								<td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="13" height="1" alt="" border="0" /></td>
								<td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="141" height="1" alt="" border="0" /></td>
						  </tr>
						  <tr>
						    <td valign="top" bgcolor="#999999"><img src="/images/spacer.gif" width="13" height="16" alt="" border="0" /></td>
								<td valign="top" bgcolor="#999999" colspan="3" class="white-text">Find information for:</td>
						  </tr>
						  <tr>
						    <td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="13" height="1" alt="" border="0" /></td>
								<td valign="top" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="13" height="1" alt="" border="0" /></td>
						  ...
						  <tr>
						    <td valign="top" colspan="2"><img src="/images/teem_lnav_arrow.gif" width="26" height="14" alt="" border="0" /></td>
								<td valign="top" colspan="2"><a href="/USA-English/GFM/Audiences/Consumers.asp" class="lnavItem">CONSUMER</a></td>
						  </tr>
						  <tr>
						    <td valign="top" colspan="4" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="180" height="1" alt="" border="0" /></td>
						  </tr>
						  <tr>
						    <td valign="top" colspan="2"><img src="/images/teem_lnav_arrow.gif" width="26" height="14" alt="" border="0" /></td>
								<td valign="top" colspan="2"><a href="/USA-English/GFM/Audiences/Businesses_Collection.asp" class="lnavItem">BUSINESS</a></td>
						  </tr>
						  <tr>
						    <td valign="top" colspan="4" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="180" height="1" alt="" border="0" /></td>
						  </tr>
						  <tr>
						    <td valign="top" colspan="2"><img src="/images/teem_lnav_arrow.gif" width="26" height="14" alt="" border="0" /></td>
								<td valign="top" colspan="2"><a href="/USA-English/GFM/Audiences/Resellers_Collection.asp" class="lnavItem">RESELLERS</a></td>
						  </tr>
						  <tr>
						    <td valign="top" colspan="4" bgcolor="#CCCCCC"><img src="/images/spacer.gif" width="180" height="1" alt="" border="0" /></td>
						  </tr>
					...
					<xsl:otherwise>
						<!--<xsl:value-of select="$desiredURL"/>-->
	...
	<!-- This table hard codes AtoZ link and the space between it and the rest of the navigation 
	***********REMOVED BY BINU GOPINATH OCTOBER 24, 2002************************
	-->		
		<!--				<table width="180" cellpadding="0" cellspacing="0" border="0">
							 <tr>
					    	<td valign="top" colspan="2"><img src="/images/spacer.gif" width="1" height="24" alt="" border="0" /></td>
					  	 </tr>
					     <tr>
						<td><img src="/images/spacer.gif" width="7" height="1" /></td>
					    	<td valign="top"><img src="/images/lnav_arrow.gif" width="6" height="14" alt="" border="0" /></td>
						<td><img src="/images/spacer.gif" width="5" height="1"/></td>
						<td valign="top" width="162"><a href="/MOBIL/USA-English/Lubes/Products_Services/A-to-Z_Collection.asp" class="lnavItem10">Products &amp; Services A - 	Z</a></td>
					  	 </tr>
						</table>-->
	<!-- End table hard codes AtoZ link and the space between it and the rest of the navigation -->		 
						<br/>
						<xsl:text disable-output-escaping="yes"><![CDATA[
			<!--googleon: index-->
			]]></xsl:text>		
