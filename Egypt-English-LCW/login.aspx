...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil in Egypt | Partner and customer login</title>
        ...
        <meta name="WT.ti" content="Mobil in Egypt | Partner and customer login"/>
    ...
    <body class="landing nosubfeatures">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d813238ef");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d813238ef','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','-30px');</script><!-- googleon: all -->
                ...
                <div id="mainContent"><div class="layoutRow clrfix"><!-- googleoff: all -->
                    <div style="z-index:450;">
                        <script type="text/javascript">quickEditForm("0915881d813238ef", "/Content/Feature",true,"../forms/LCWLandingFeature","","790px","700px","Landing Page Feature and Subfeatures","","pencil.gif","210px");</script>
                    </div><!-- googleon: all -->
                    <div id="mainFeature">
                        <p xmlns="">
                        ...
                        <p xmlns="">If you are a pre-registered channel partner, distributor or customer of ExxonMobil, there are several options for you to access available information.</p> </div>
            <div id="subfeatureCallouts">
                    ...
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d813238ef", "/Content/SLeftColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Left Landing Page Column","","pencil.gif","");</script><!-- googleon: all --><div xmlns="" class="headerbar">
                                <h3>
                            ...
                            <div xmlns="" class="padding">
                                ...
                                <p>If you are a pre-registered customer&nbsp; or supplier of ExxonMobil, you can access your <a title="" target="_blank" onclick="trackClick(this);" href="http://portal.exxonmobil.com/" class="">personalised portal</a>.</p>
                            </div>
                        </div>
                        <div class="subfeature csingle cright"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d813238ef", "/Content/SRightColumn/Section",true,"../forms/LCWLandingColumns","20px","820px","700px","Right Landing Page Column","","pencil.gif","");</script><!-- googleon: all --><div xmlns="" class="headerbar">
                                <h3>
                                    <a title="" target="_self" onclick="trackClick(this);" href="http://www.signumoilanalysis.com">Signum oil analysis<span></span></a>
                                </h3>
                            </div>
                            <div xmlns="" class="padding">
                                <div class="img60 left"><a href="http://www.signumoilanalysis.com" title="Signum oil analysis" target="_self" onclick="trackClick(this);"><a title="This link will open a new window." target="_blank" onclick="trackClick(this);" href="http://www.signumoilanalysis.com"><img title="Signum Oil Pour" src="../Shared-Images-LCW/teaser_60x60_signum-oil-pour_gbl.jpg" longdesc="" class="floatimgleft" border="0" alt="Signum Oil Pour"></a></a></div>
                                <p>Our state-of-the-art used oil analysis programs, such as Signum<sup>SM</sup>, provide the insight you need to better understand the condition of your company&rsquo;s lubricants and equipment. Click here to access <a title="" target="" onclick="trackClick(this);" href="http://www.signumoilanalysis.com" class="">Signum oil analysis</a> or existing users, can <a title="" target="_blank" onclick="trackClick(this);" href="http://portal.exxonmobil.com" class="">log in here</a>.&nbsp;</p>
                            </div>
                        </div>
                    </div>
                    <div class="layoutRow clrfix">
                        <div class="subfeature csingle cleft">
                            <div xmlns="" class="headerbar">
                                <h3>
                                    <a title="" target="_self" onclick="trackClick(this);" href="../Egypt-English-LCW/contactus_contact.aspx?CountryCode=EG&amp;Language=English">looking to register?<span></span></a>
                                </h3>
                            </div>
                            <div xmlns="" class="padding">
                                <div class="img60 left"><a href="../Egypt-English-LCW/contactus_contact.aspx?CountryCode=EG&amp;Language=English" title="looking to register?" target="_self" onclick="trackClick(this);"><img title="Customer Support" src="../Shared-Images-LCW/teaser_60x60_customer-support_gbl.jpg" longdesc="" class="floatimgleft" border="0" alt="Customer Support"></a></div>
                                <p>Not a registered user? You&rsquo;re missing out on a lot of important information! Ask your company&rsquo;s <a title="" target="" onclick="trackClick(this);" href="/Egypt-English-LCW/contactus_contact.aspx?CountryCode=EG&amp;Language=English" class="">key contact</a> to enroll you today.</p>
                            </div>
                        </div>
                    </div>
                </div>
