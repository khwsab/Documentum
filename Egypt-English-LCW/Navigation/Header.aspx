...
<div id="globalHeader" class="clrfix">
    <script type="text/javascript">quickEditForm("0915881d81fe8380", "/Content/Logo",false,"../forms/LCWHeaderLogo","","625px","500px","Header Logo","","pencil.gif","");</script><a onclick="trackClick(this);" href="/Egypt-English-LCW/default.aspx"><img title="" src="/Shared-Images-LCW/headerlogo_86x30_mobil-logo_gbl.jpg" longdesc="" id="logo" border="0" alt="Mobil logo 1"></a>
...
<div style="z-index:450;">
    <script type="text/javascript">quickEditForm("0915881d81fe8380", "/Content/Top_Navigation",true,"../forms/LCWHeaderTopNav","","680px","700px","Top Navigation","","pencil.gif","");</script>
</div>
<div id="mainNav" class="clrfix">
    <div id="BlueNavPanel_Current_2">
        ...
        <div class="navBarLeft">
            <ul>
                <li>
                    <a target="" onclick="trackClick(this);" href="/Egypt-English-LCW/carengineoils.aspx" id="carengineoils">car engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/Egypt-English-LCW/heavydutyoils.aspx" id="heavydutyoils">heavy duty engine oils</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/Egypt-English-LCW/industrialspecialty.aspx" id="industrialspecialty">industrial &amp; specialty lubricants</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/Egypt-English-LCW/buy.aspx" id="wheretobuy">where to buy</a>
                </li>
                <li>
                    <a target="" onclick="trackClick(this);" href="/Egypt-English-LCW/mobilbrands.aspx" id="mobilbrands">Mobil brands</a>
                </li>
            </ul>
        </div>
