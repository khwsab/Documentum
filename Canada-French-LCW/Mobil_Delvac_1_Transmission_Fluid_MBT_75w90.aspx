...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil_Delvac_1_Transmission_Fluid_MBT_75w90</title>
        <meta name="keywords" content="Mobil_Delvac_1_Transmission_Fluid_MBT_75w90"/>
        <meta name="description" content="Mobil_Delvac_1_Transmission_Fluid_MBT_75w90"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Mobil_Delvac_1_Transmission_Fluid_MBT_75w90"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d8207b3e4");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d8207b3e4','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d8207b3e4', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d8207b3e4', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                                <div style="z-index:100; " id="divTabs">
                                    <ul>
                                        <li onmouseover="if(this.className!='current')this.className='highlight';" onmouseout="if(this.className!='current')this.className=''" class="current" id="Caractéristiques">
                                        ...
                                        <li onmouseover="if(this.className!='current')this.className='highlight'" onmouseout="if(this.className!='current')this.className=''" id="Propriétés typiques">
                                            <a href="#" onclick="javascript:showTab('Propriétés typiques');">Propriétés typiques</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Caractéristiques Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT 75W-90 est formulée à partir d'un système d'additifs évolués assurant une excellente stabilité thermique et une résistance à l'usure exceptionnelle. Mobil Delvac 1 Transmission Fluid MBT 75W-90 maintien des températures plus basses dans les transmissions que les huiles conventionnelles pour transmissions. Elle est recommandée pour la plupart des transmissions manuelles, des boîtes-ponts et des ponts hypoïdes intermédiaires pour lesquels une huile API GL-5 n'est pas exigée. Mobil Delvac 1 Transmission Fluid MBT 75W-90 convient aux transmissions (boîtes de vitesses) où les lubrifiants sont exposés à de très hautes températures dans un service en pleine charge.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT 75W-90 répond à la spécification MB 235.11 de Mercedes-Benz concernant les transmissions manuelles des modèles Actros, y compris celles équipées de boîtes de transfert.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Spécifications Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT 75W-90 est homologuée par les constructeurs suivants:</p>

                                    <p xmlns="">Homologation MB 235.11</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Propriétés typiques Content">
                                    <p xmlns="">
                                        <br>
Mobil Delvac 1 Transmission Fluid MBT 75W-90</p>
                                    <p xmlns="">Grade SAE :SAE 75W-90</p>
                                    <p xmlns="">Viscosité, ASTM D 445 cSt @ 40 ºC: 96,3</p>
                                    <p xmlns="">cSt @ 100 ºC: 14,7</p>
                                    <p xmlns="">Viscosité Brookfield à -40 ºC: cP max 59000</p>
                                    <p xmlns="">Point d'écoulement, °C, ASTM D 97: -45</p>
                                    <p xmlns="">Point d'éclair, ºC, ASTM D 92, min: 179</p>
                                    <p xmlns="">Indice de viscosité, ASTM D 2270: 159</p>
                                </div>
                            </td>
