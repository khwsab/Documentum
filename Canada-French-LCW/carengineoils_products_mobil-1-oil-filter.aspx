...
<%@ Register Src="Navigation/motoroils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil&trade; Canada | Huiles Pour Moteurs de Voitures |&nbsp; Les produits | Filtre à huile Mobil 1 &ndash; Performance prolongée</title>
        <meta name="keywords" content="Huiles Pour Moteurs de Voitures, Mobil 1 Oil Filter"/>
        <meta name="description" content="Mobil 1&trade; Oil Filter"/>
        <meta name="date" content="2010-01-01"/>
        <meta name="language" content="fr"/>
        <meta http-equiv="Content-Language" content="fr"/>
        <meta name="WT.ti" content="Mobil&trade; Canada | Huiles Pour Moteurs de Voitures |&nbsp; Les produits | Filtre à huile Mobil 1 &ndash; Performance prolongée"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d819c7cf1");</script>
        </div>
        ...
        <div id="container">
            <div id="HomePanel_1"><!--#include file="Navigation/Header.aspx" -->
                ...
                <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm('0915881d819c7cf1','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                    ...
                    <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" -->
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d819c7cf1", "/Content/Related_Content_Settings",true,"../forms/LCWRelatedContent","","820px","680px","Related Content","","pencil.gif","");</script><!-- googleon: all --></div>
                        <div style="float:left;width:201px"><!-- googleoff: all -->
                            <script type="text/javascript">quickEditForm("0915881d819c7cf1", "/Content/Related_Media",true,"../forms/LCWRelatedMedia","","820px","680px","Related Media","","pencil.gif","");</script><!-- googleon: all --></div>
                    </div>
                    <div id="mainContent_thin"><!-- googleoff: all -->
                        <script type="text/javascript">quickEditForm("0915881d819c7cf1", "/Content",false,"../forms/LCWArticle","","840px","700px","Article Content","","pencil.gif","200px");</script><!-- googleon: all -->
                        <div id="flashvidpad">
                            <div id="flashVideoTop"/>
                        </div>
                        <p xmlns="">
                            <img src="../Shared-Images-LCW/article_150x150_ep-filter_amer.jpg" height="150" width="150" alt="Mobil 1 Oil Filter" title="Mobil 1 Oil Filter" align="left" border="0" hspace="0" class="imgFloatLeft"></p>

                        <h1 xmlns="">Filtre à huile Mobil 1&trade; &ndash; Performance prolongée</h1>

                        <p xmlns="">Les filtres à huile Mobil 1 &ndash; performance prolongée offrent un rendement de qualité supérieure équilibré et sont conçus pour l&rsquo;utilisation avec toutes les huiles synthétiques ou classiques. Un mélange de fibres élimine plus de contaminants que les filtres traditionnels permettant des intervalles de vidange plus longs.* <br>

                            <br>
*Consultez toujours le guide d'entretien de votre véhicule.</p>
                    </div>
                </div>
