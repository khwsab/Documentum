...
<%@ Register Src="Navigation/buy.ascx" TagName="Navigation" TagPrefix="xom" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">

<head>
    <meta http-equiv="X-UA-Compatible" content="IE=8">
    <title>Mobil Canada | Comment Acheter | Mobil 1 Lube Express</title>
    <meta name="keywords" content="Mobil 1 Lube Express" />
    <meta name="description" content="Mobil 1 Lube Express" />
    <meta name="date" content="2010-01-01" />
    <meta name="language" content="fr" />
    <meta http-equiv="Content-Language" content="fr" />
    <meta name="WT.ti" content="Mobil Canada | Comment Acheter | Mobil 1 Lube Express" />
...
<body class="article">
    <div style="text-align:left">
        <script type="text/javascript">displaySuperPencil("0915881d8202559f");</script>
    </div>
    ...
    <div id="container">
        ...
        <div id="mainPanel" class="clrfix">
            <!-- googleoff: all -->
            <script type="text/javascript">quickEditForm('0915881d8202559f', '/Content', false, '../forms/LCWLeftNav', '', '500px', '300px', 'Display/Hide Left Navigation', '', 'pencil.gif', '10px');</script><!-- googleon: all -->
            <div id="sideBar" class="clrfix">
                <xom:Navigation ID="LeftNav" runat="server" />
                <!--#include file="Navigation/QuickLinks_buy.aspx"-->
            </div>
            <div id="toolbar_wide">
                <!--#include file="Services/Toolbox.aspx" -->
                <div style="float:left;width:201px">
                    <!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm("0915881d8202559f", "/Content/Related_Content_Settings", true, "../forms/LCWRelatedContent", "", "820px", "680px", "Related Content", "", "pencil.gif", "");</script><!-- googleon: all -->
                </div>
                <div style="float:left;width:201px">
                    <!-- googleoff: all -->
                    <script type="text/javascript">quickEditForm("0915881d8202559f", "/Content/Related_Media", true, "../forms/LCWRelatedMedia", "", "820px", "680px", "Related Media", "", "pencil.gif", "");</script><!-- googleon: all -->
                </div>
            </div>
            <div id="mainContent_thin">
                <!-- googleoff: all -->
                <script type="text/javascript">quickEditForm("0915881d8202559f", "/Content", false, "../forms/LCWArticle", "", "840px", "700px", "Article Content", "", "pencil.gif", "200px");</script><!-- googleon: all -->
                <div id="flashvidpad">
                ...
                <p xmlns="">Que vous soyez un fournisseur en services de lubrification rapide actuel ou futur, vous
                    disposez maintenant une occasion d'accroître votre offre de services avec Mobil 1&trade; en
                    devenant un centre de changement d'huile Mobil 1 Lube Express entièrement personnalisé grâce au
                    programme Mobil Bulk.</p>

                <p xmlns="">Le programme Mobil 1 Lube Express peut vous assister dans la création d'une nouvelle image
                    et vous aider à améliorer votre potentiel de ventes et de rendement par le biais de promotions
                    solides, d'outils de vente et de formation. La marque Mobil 1 Lube Express offre une image
                    accrocheuse contribuant à attirer de nouveaux clients vers votre entreprise.</p>

                <p xmlns="">Au c&#339;ur de ce programme se trouve la performance insurpassée que vous obtiendrez avec
                    la gamme complète de lubrifiants Mobil&trade; de qualité supérieure que les clients connaissent et
                    en laquelle ils ont confiance &mdash; de la Mobil Super&trade; 1000 et Mobil Super&trade; 2000
                    jusqu'à notre ligne complète d'huiles à moteur synthétiques Mobil 1 et Mobil 1&trade;&nbsp;
                    Performance prolongée.</p>

                <p xmlns="">
                    <br>
                    Si vous avez des questions ou des commentaires relativement au programme, veuillez communiquer avec
                    nous par écrit à <a title="" target="" onclick="trackClick(this);" href="https://www.imperialoil.ca/en-ca/company/contact-us/contact-us-by-email/email-form"
                        class="">ici.</a>
                </p>
                        ...
                        <tbody>
                            <tr>
                                <td width="50%" height="" class="standard">
                                    ...
                                    <p>Mobil 1 Auto Service & Lube Express<br>
                                        ...
                                        <br>
                                        Web: <a title="" target="_blank" onclick="trackClick(this);" href="https://www.mobil1autoservice.com/"
                            ...
                            <tr>
                                <td width="50%" height="" class="standard">1710054 Alberta Ltd<br>
                                    ...
                                    403-931-4300<br>
                                    &nbsp;
                                    <p>Web: <a title="" target="" onclick="trackClick(this);" href="http://www.mobil1calgary.com"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="50%" height="" class="standard">9541 Investments Ltd<br>
                                    ...
                                    Web: <a title="" target="_blank" onclick="trackClick(this);" href="http://www.mobil1walnutgrove.com"
                                        class="">www.mobil1walnutgrove.com</a></td>
                                <td width="50%" height="" class="standard">
                                    <p>0885988 BC Ltd<br>
                            ...
                            <tr>
                                ...
                                <td width="" height="" class="standard">
                                    ...
                                    <p>Web: <a title="" target="_blank" onclick="trackClick(this);" href="http://www.langleymobil1.com"
                                            class="">www.langleymobil1.com</a>
                                    </p>
                            ...
                            <tr>
                                <td width="50%" height="" class="standard">
                                    ...
                                    <p>Web: <a title="" target="" onclick="trackClick(this);" href="http://www.abbotsfordmobil1.com"
                            ...
                            <tr>
                                ...
                                <td width="50%" height="" class="standard">
                                    ...
                                    <p>Mobil 1 Lube Express <br>
                                        ...
                                        <br>
                                        British Columbia, V6X 2T4<br>
                                        604-278-1999</p>

                                    <p>Web: <a title="" target="" onclick="trackClick(this);" href="http://www.mobil1richmond.com"
                        ...
                        <tbody>
                            <tr>
                                <td width="50%" height="" class="standard">
                                    ...
                                    <p>
                                        <strong>Lester Lube</strong>
                                        <br>
                                        1078 Topsail Road,<br>
